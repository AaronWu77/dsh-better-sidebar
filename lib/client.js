window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function createBetterSidebarService(store) {
			...
			*  open-path interception, so distinct files open side by side). */
			...
			const listOpenTabs = () => {
				...
				const local = state === void 0 ? [] : allLeaves(state.bottomSplits).flatMap((leaf) => leaf.tabs);
				if (surface === void 0 || snapshot.sessionId === void 0) return local;
				const native = surface.openTabs().filter((entry) => entry.sessionId === snapshot.sessionId).map((entry) => entry.tab);
				return [...local, ...native];
			};
			return {
				registerTab,
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\builtins\tab-icons.module.css.mjs
		const css$8 = "._4SVkPG_files{color:var(--dsw-alias-brand-primary,var(--dsw-alias-label-primary))}._4SVkPG_changes{color:var(--dsw-alias-state-success-primary,var(--dsw-alias-brand-primary,var(--dsw-alias-label-primary)))}._4SVkPG_tasks{color:var(--dsw-alias-state-warn-primary,var(--dsw-alias-label-primary))}._4SVkPG_sidechat{color:var(--dsw-alias-state-business-primary,var(--dsw-alias-brand-primary,var(--dsw-alias-label-primary)))}._4SVkPG_terminal{color:var(--dsw-alias-label-primary)}._4SVkPG_browser{color:var(--dsw-alias-state-business-primary,var(--dsw-alias-brand-primary,var(--dsw-alias-label-primary)))}";
		...
		var tab_icons_module_css_default = {
			"tasks": "_4SVkPG_tasks",
			"changes": "_4SVkPG_changes",
			"sidechat": "_4SVkPG_sidechat",
			"files": "_4SVkPG_files",
			"terminal": "_4SVkPG_terminal",
			"browser": "_4SVkPG_browser"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\sidebar.module.css.mjs
		const css$6 = "[data-dsh-panel-host]{z-index:25;pointer-events:none;position:fixed;inset:0;overflow:clip}[data-dsh-panel-host][data-dsh-panel-host-degraded]{position:absolute;top:0;left:0}._8Lf9RG_toggleButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), color var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;justify-content:center;align-items:center;display:flex}._8Lf9RG_toggleButton:hover:not(:disabled):not([aria-disabled=true]){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_toggleButton:disabled,._8Lf9RG_toggleButton[aria-disabled=true]{opacity:.4;cursor:default}._8Lf9RG_panelBody{flex:1;min-width:0;min-height:0;display:flex}._8Lf9RG_bottomPanel{z-index:40;background:var(--dsw-alias-bg-layer-1);border-top:1px solid var(--dsw-alias-border-l2);pointer-events:auto;padding-bottom:env(safe-area-inset-bottom);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex-direction:column;display:flex;position:absolute;bottom:0}._8Lf9RG_bottomPanelHidden{pointer-events:none;visibility:hidden;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out), height var(--ds-transition-duration-slow) var(--ds-ease-in-out), visibility 0s linear var(--ds-transition-duration-slow);transform:translateY(102%)}._8Lf9RG_bottomPanel[data-dragging]{transition:none}._8Lf9RG_bottomPanel{contain:layout style}body[data-dsh-sidebar-dragging] ._8Lf9RG_panel,body[data-dsh-sidebar-dragging] ._8Lf9RG_bottomPanel{will-change:transform}._8Lf9RG_bottomResize{cursor:row-resize;z-index:2;touch-action:none;height:8px;position:absolute;top:-4px;left:0;right:0}._8Lf9RG_bottomResizeActive{background:var(--dsw-alias-interactive-bg-hover-accent)}._8Lf9RG_bottomClose{z-index:4;width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:3px;right:6px}._8Lf9RG_bottomClose:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_bottomPanel ._8Lf9RG_tabBar{padding-right:40px}._8Lf9RG_toggleButton,._8Lf9RG_tabBar{-webkit-app-region:no-drag}._8Lf9RG_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._8Lf9RG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_iconButton:disabled{opacity:.4;cursor:default}._8Lf9RG_workbench,._8Lf9RG_split{flex:1;min-width:0;min-height:0;display:flex}._8Lf9RG_splitRow{flex-direction:row}._8Lf9RG_splitCol{flex-direction:column}._8Lf9RG_splitChild{display:flex;position:relative;overflow:hidden}._8Lf9RG_divider{z-index:3;touch-action:none;flex:none;position:relative}._8Lf9RG_dividerRow:after,._8Lf9RG_dividerCol:after{content:\"\";background:var(--dsw-alias-border-l2);transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out);position:absolute}._8Lf9RG_dividerRow{cursor:col-resize;width:7px;margin:0 -2px}._8Lf9RG_dividerRow:after{width:1px;top:0;bottom:0;left:50%;transform:translate(-50%)}._8Lf9RG_dividerCol{cursor:row-resize;height:7px;margin:-2px 0}._8Lf9RG_dividerCol:after{height:1px;top:50%;left:0;right:0;transform:translateY(-50%)}._8Lf9RG_divider:hover:after,._8Lf9RG_dividerActive:after{background:var(--dsw-alias-interactive-bg-hover-accent)}._8Lf9RG_pane{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}._8Lf9RG_paneDrop{outline:1px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}._8Lf9RG_dropOverlay{z-index:6;pointer-events:none;background:var(--dsw-alias-interactive-bg-hover-accent);opacity:.5;position:absolute}._8Lf9RG_dropLeft{width:25%;top:0;bottom:0;left:0}._8Lf9RG_dropRight{width:25%;top:0;bottom:0;right:0}._8Lf9RG_dropUp{height:25%;top:0;left:0;right:0}._8Lf9RG_dropDown{height:25%;bottom:0;left:0;right:0}._8Lf9RG_dropCenter{outline:2px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-2px;background:0 0;inset:25%}._8Lf9RG_paneContent{flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden}._8Lf9RG_chipIcon{flex:none;align-items:center;margin-right:6px;display:inline-flex}._8Lf9RG_paneTab{flex-direction:column;flex:1;min-height:0;display:flex}._8Lf9RG_paneTabHidden{display:none}._8Lf9RG_paneEmptyCards{flex:1;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));align-content:start;gap:8px;min-height:0;padding:12px;display:grid;overflow:hidden}._8Lf9RG_paneCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;gap:6px;padding:12px 8px;display:flex}._8Lf9RG_paneCard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l2)}._8Lf9RG_paneCard:disabled{opacity:.45;cursor:default}._8Lf9RG_tabBar{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);flex:none;align-items:stretch;height:34px;display:flex}._8Lf9RG_tabBarDrop{outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}._8Lf9RG_tabList{scrollbar-width:none;flex:1;min-width:0;display:flex;overflow-x:auto}._8Lf9RG_tabList::-webkit-scrollbar{display:none}._8Lf9RG_tab{min-width:64px;max-width:160px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);border-right:1px solid var(--dsw-alias-border-l1);cursor:pointer;user-select:none;background:0 0;flex:none;align-items:center;gap:4px;padding:0 4px 0 10px;display:flex}._8Lf9RG_tab:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_tabActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}._8Lf9RG_tabTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._8Lf9RG_tabBadge{min-width:16px;height:15px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-brand-primary);border-radius:8px;flex:none;justify-content:center;align-items:center;padding:0 4px;display:inline-flex}._8Lf9RG_tabClose{width:18px;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._8Lf9RG_tabClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_tabBarPlus{background:var(--dsw-alias-bg-layer-1);width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border:none;border-radius:5px;flex:none;justify-content:center;align-self:center;align-items:center;margin:0 6px;padding:0;display:inline-flex;position:sticky;right:0}._8Lf9RG_tabBarPlus:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_pinnedTab{color:var(--dsw-alias-label-tertiary);font-style:italic}._8Lf9RG_pinnedTab:hover{color:var(--dsw-alias-label-secondary)}._8Lf9RG_explorer{flex-direction:column;flex:1;min-height:0;display:flex}._8Lf9RG_explorerHeader{flex:none;justify-content:space-between;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._8Lf9RG_explorerRoot{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._8Lf9RG_explorerBody{flex:1;min-height:0;padding:4px 8px 8px;overflow:hidden auto}._8Lf9RG_explorerRow{box-sizing:border-box;width:100%;max-width:100%;height:34px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;white-space:nowrap;animation:_8Lf9RG_dsh-row-in .15s var(--ds-ease-in-out);background:0 0;border:none;border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}._8Lf9RG_explorerRow:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_explorerRowRevealed{background:var(--dsw-alias-state-business-tertiary)}._8Lf9RG_explorerRowRevealed+._8Lf9RG_explorerRowRevealed{border-top-left-radius:0;border-top-right-radius:0}._8Lf9RG_explorerRowRevealed:has(+._8Lf9RG_explorerRowRevealed){border-bottom-right-radius:0;border-bottom-left-radius:0}._8Lf9RG_explorerDir{font:var(--dsw-font-s-strong-14)}._8Lf9RG_explorerHidden{opacity:.45}._8Lf9RG_explorerSymlink{color:var(--dsw-alias-label-tertiary);flex:none}._8Lf9RG_explorerBroken ._8Lf9RG_explorerName{color:var(--dsw-alias-state-error-primary)}._8Lf9RG_explorerName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._8Lf9RG_explorerRenaming{cursor:text}._8Lf9RG_explorerRenameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1);min-width:0;height:24px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:auto;padding:0 6px}._8Lf9RG_explorerRenameInput:focus{border-color:var(--dsw-alias-state-business-primary);outline:none}._8Lf9RG_explorerActionError{box-sizing:border-box;border:1px solid var(--dsw-alias-state-error-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px;align-items:flex-start;gap:6px;width:100%;margin-bottom:4px;padding:6px 8px;display:flex}._8Lf9RG_explorerActionErrorText{overflow-wrap:anywhere;min-width:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex:auto}._8Lf9RG_explorerActionErrorClose{width:20px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._8Lf9RG_explorerActionErrorClose:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_explorerConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;margin:0}._8Lf9RG_explorerRef,._8Lf9RG_explorerCopied{margin-left:auto}._8Lf9RG_explorerRef{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:20px;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;align-items:center;padding:0 8px;display:none}._8Lf9RG_explorerRef:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_explorerRow:hover ._8Lf9RG_explorerRef,._8Lf9RG_explorerRow:focus-within ._8Lf9RG_explorerRef{display:inline-flex}._8Lf9RG_explorerCopied{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._8Lf9RG_explorerError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);cursor:default}@keyframes _8Lf9RG_dsh-row-in{0%{opacity:0}}._8Lf9RG_explorerEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}._8Lf9RG_explorerRowDropTarget{background:var(--dsw-alias-interactive-bg-hover);outline:1px dashed var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}._8Lf9RG_uploadDropZone{z-index:1001;pointer-events:none;border:2px dashed var(--dsw-alias-interactive-bg-hover-accent);box-shadow:0 0 0 200vmax var(--dsw-alias-bg-mask-drop);animation:_8Lf9RG_dsh-row-in .15s var(--ds-ease-in-out);border-radius:10px;justify-content:center;align-items:flex-start;padding:12px;display:flex;position:fixed}._8Lf9RG_uploadDropHero{flex-direction:column;align-items:center;gap:10px;max-width:100%;padding-top:8px;display:flex}._8Lf9RG_uploadDropZonePill{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:100%;box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);border-radius:999px;align-items:center;gap:6px;padding:6px 12px;display:flex}._8Lf9RG_uploadDropZoneText{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}._8Lf9RG_uploadDropChatHint{z-index:1002;pointer-events:none;animation:_8Lf9RG_dsh-row-in .15s var(--ds-ease-in-out);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;top:0;bottom:0;left:0}._8Lf9RG_uploadDropChatCard{text-align:center;max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-strong-14);flex-direction:column;align-items:center;gap:12px;display:flex}._8Lf9RG_uploadOverlay{z-index:30;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);animation:_8Lf9RG_dsh-row-in .15s var(--ds-ease-in-out);justify-content:center;align-items:center;display:flex;position:absolute;inset:0}._8Lf9RG_uploadOverlayCard{border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-alias-bg-layer-2);min-width:280px;max-width:min(420px,100% - 48px);box-shadow:var(--dsw-shadow-lv3);border-radius:24px;flex-direction:column;gap:12px;padding:20px 24px;display:flex}._8Lf9RG_uploadOverlayTitle{font:var(--dsw-font-s-strong-14);color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}._8Lf9RG_uploadOverlayTitle>svg{flex:none}._8Lf9RG_uploadOverlayTitle>span{white-space:nowrap;text-overflow:ellipsis;min-width:0;overflow:hidden}._8Lf9RG_uploadOverlayProgress{background:var(--dsw-alias-border-l2);border-radius:3px;height:6px;overflow:hidden}._8Lf9RG_uploadOverlayProgressFill{background:var(--dsw-alias-interactive-bg-hover-accent);height:100%;transition:width .15s var(--ds-ease-in-out);border-radius:3px}._8Lf9RG_uploadOverlayStatus{min-height:1em;font:var(--dsw-font-xxs-12);font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;overflow:hidden}._8Lf9RG_uploadOverlayCancel{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;background:0 0;border-radius:8px;align-self:flex-end;padding:0 14px}._8Lf9RG_uploadOverlayCancel:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}._8Lf9RG_uploadOverlayCancel:disabled{opacity:.4;cursor:default}._8Lf9RG_editor{flex-direction:column;flex:1;min-height:0;display:flex}._8Lf9RG_editorHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:6px 8px;display:flex}._8Lf9RG_editorTitle{min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._8Lf9RG_editorPathInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}._8Lf9RG_editorPathInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}._8Lf9RG_editorTreeToggleActive{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-active)}._8Lf9RG_editorBody{flex:1;min-height:0;display:flex}._8Lf9RG_editorMain{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex}._8Lf9RG_editorTreeDock{border-left:1px solid var(--dsw-alias-border-l1);flex:none;min-height:0;display:flex;position:relative}._8Lf9RG_editorTreeResize{cursor:col-resize;touch-action:none;z-index:3;width:6px;position:absolute;top:0;bottom:0;left:0}._8Lf9RG_editorTreeResize:hover{background:var(--dsw-alias-border-l2)}._8Lf9RG_editorTreePanel{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;position:relative}._8Lf9RG_editorTreePanelFull{flex:1}._8Lf9RG_editorTreeSearch{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:6px;padding:6px 8px;display:flex}._8Lf9RG_editorSearchInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}._8Lf9RG_editorSearchInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}._8Lf9RG_editorSearchHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:8px 12px}._8Lf9RG_editorSearchResult{width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);text-align:left;cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 8px;display:block;overflow:hidden}._8Lf9RG_editorSearchResult:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_editorStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}._8Lf9RG_editorStatusError{color:var(--dsw-alias-state-error-primary)}._8Lf9RG_dirtyDot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;flex:none;width:7px;height:7px}._8Lf9RG_editorPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex:1;justify-content:center;align-items:center;padding:16px;display:flex}._8Lf9RG_orphanedType{opacity:.7;overflow-wrap:anywhere;margin-top:8px;font-size:12px;display:block}._8Lf9RG_editorBinary{text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:12px;padding:24px 16px;display:flex}._8Lf9RG_editorBinaryNotice{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._8Lf9RG_editorDownloadLink{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-strong-12);cursor:pointer;transition:background var(--ds-transition-duration-slow) var(--ds-ease-in-out), border-color var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:6px;align-items:center;gap:6px;padding:6px 14px;text-decoration:none;display:inline-flex}._8Lf9RG_editorDownloadLink:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l2)}._8Lf9RG_editorError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);padding:12px 16px}._8Lf9RG_fenceError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-wrap:wrap;align-items:center;gap:8px;padding:8px 16px;display:flex}._8Lf9RG_editorBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 8px}._8Lf9RG_sandboxStatus{font:var(--dsw-font-xxxs-11);flex:none;align-items:center;gap:8px;padding:4px 10px;display:flex}._8Lf9RG_sandboxStatusOn{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l1)}._8Lf9RG_sandboxStatusOff{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 10%, transparent);border-bottom:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent)}._8Lf9RG_sandboxDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:6px;height:6px}._8Lf9RG_sandboxStatusOff ._8Lf9RG_sandboxDot{background:var(--dsw-alias-state-error-primary)}._8Lf9RG_sandboxStatusText{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._8Lf9RG_sandboxAction{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:6px;flex:none;padding:2px 8px}._8Lf9RG_sandboxAction:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_editorHtml{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._8Lf9RG_browser{flex-direction:column;flex:1;min-height:0;display:flex}._8Lf9RG_browserBar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:4px;padding:6px 8px;display:flex}._8Lf9RG_browserInput{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:0;height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 10px}._8Lf9RG_browserInput:focus{border-color:var(--dsw-alias-border-l2);outline:none}._8Lf9RG_browserMessage{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;padding:4px 12px}._8Lf9RG_browserFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._8Lf9RG_browserStart{text-align:center;min-height:0;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);flex:1;justify-content:center;align-items:center;padding:20px;display:flex}._8Lf9RG_browserBlocked{text-align:center;min-height:0;color:var(--dsw-alias-state-warn-primary);flex-direction:column;flex:1;justify-content:center;align-items:center;gap:6px;padding:24px;display:flex}._8Lf9RG_browserBlockedTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary)}._8Lf9RG_browserBlockedDesc{max-width:280px;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary)}._8Lf9RG_browserBlockedActions{gap:8px;margin-top:6px;display:flex}._8Lf9RG_browserBlockedButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-11);cursor:pointer;border-radius:6px;padding:4px 12px}._8Lf9RG_browserBlockedButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_editorCm{background:0 0;flex:1;min-height:0;overflow:hidden}._8Lf9RG_editorCmHidden{display:none}._8Lf9RG_editorCm .cm-editor{height:100%}._8Lf9RG_editorCm .cm-scroller{padding:12px 16px}._8Lf9RG_editorCm .cm-editor.cm-focused{outline:none}._8Lf9RG_editorModeToggle{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;align-items:center;gap:2px;padding:2px;display:inline-flex}._8Lf9RG_editorModeButton{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:2px 8px}._8Lf9RG_editorModeButton:hover{color:var(--dsw-alias-label-primary)}._8Lf9RG_editorModeActive{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}._8Lf9RG_editorImageWrap{flex:1;justify-content:center;align-items:center;min-height:0;padding:12px;display:flex;overflow:auto}._8Lf9RG_editorImage{object-fit:contain;max-width:100%;max-height:100%}._8Lf9RG_editorMd{min-height:0;font:var(--dsw-font-xs-13);flex:1;padding:12px 16px;overflow-y:auto}._8Lf9RG_editorMd .md-code-block:not([data-mermaid-processed])>div:first-child{z-index:auto;position:static}._8Lf9RG_mermaidWrap{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;margin:6px 0;overflow:hidden}._8Lf9RG_mermaidHeader{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);justify-content:space-between;align-items:center;gap:6px;padding:4px 8px;display:flex}._8Lf9RG_mermaidInfo{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary)}._8Lf9RG_mermaidCopy{height:20px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border:none;border-radius:4px;align-items:center;gap:4px;padding:0 6px;display:inline-flex}._8Lf9RG_mermaidCopy:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_mermaidBody{cursor:zoom-in;justify-content:center;padding:10px;display:flex;overflow:auto}._8Lf9RG_mermaidBody svg{max-width:100%;height:auto}._8Lf9RG_mermaidError{border-bottom:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-11);padding:6px 10px}._8Lf9RG_mermaidCode{font:var(--dsw-font-xxxs-11);margin:0;padding:8px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow:auto}._8Lf9RG_mermaidMarkdown .md-code-block[data-mermaid-processed]{display:contents}._8Lf9RG_mermaidModal{z-index:1000;background:var(--dsw-alias-bg-mask-1);backdrop-filter:blur(2px);flex-direction:column;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._8Lf9RG_mermaidModalToolbar{z-index:10;gap:8px;display:flex;position:absolute;top:16px;right:16px}._8Lf9RG_mermaidModalButton{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);width:36px;height:36px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xs-strong-13);cursor:pointer;border-radius:8px;justify-content:center;align-items:center;display:inline-flex}._8Lf9RG_mermaidModalButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_mermaidModalStage{justify-content:center;align-items:center;width:90vw;height:80vh;display:flex;position:relative;overflow:hidden}._8Lf9RG_mermaidModalStage svg{cursor:grab;transform-origin:50%;user-select:none;-webkit-user-drag:none;background:var(--dsw-alias-bg-layer-1);border-radius:12px;max-width:none;max-height:none;padding:16px}._8Lf9RG_mermaidModalStage svg:active{cursor:grabbing}._8Lf9RG_mermaidModalHint{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);pointer-events:none;position:absolute;bottom:16px;left:50%;transform:translate(-50%)}._8Lf9RG_selectionPopup{z-index:60;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;cursor:pointer;border-radius:6px;align-items:center;padding:0 10px;display:inline-flex;position:fixed;transform:translate(-50%,calc(-100% - 8px))}._8Lf9RG_selectionPopup:hover{background:var(--dsw-alias-interactive-bg-hover)}._8Lf9RG_editorPdf{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex}._8Lf9RG_editorPdfToolbar{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:flex-end;padding:6px 8px;display:flex}._8Lf9RG_editorPdfStage{flex:1;min-height:0;display:flex;position:relative}._8Lf9RG_editorPdfFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%;min-height:0}._8Lf9RG_editorPdfFrameBlocked{pointer-events:none}._8Lf9RG_editorPdfDragShield{z-index:4;pointer-events:none;background:0 0;position:absolute;inset:0}._8Lf9RG_editorPdfDragShieldActive{pointer-events:auto}body[data-dsh-tab-dragging] ._8Lf9RG_editorPdfFrame{pointer-events:none!important}body[data-dsh-tab-dragging] ._8Lf9RG_editorPdfDragShield{pointer-events:auto!important}._8Lf9RG_terminalWrap{background:var(--dsw-alias-bg-base);flex-direction:column;flex:1;min-height:0;display:flex;position:relative}._8Lf9RG_terminal{flex:1;min-height:0;padding:6px 4px 6px 8px}._8Lf9RG_terminal .xterm{height:100%}._8Lf9RG_terminalBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}._8Lf9RG_terminalBannerUrl{word-break:break-all;opacity:.85;flex-basis:100%;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._8Lf9RG_terminalWaitBanner{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex:none;align-items:center;gap:8px;padding:3px 10px;display:flex}._8Lf9RG_terminalWaitNeedle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._8Lf9RG_boundaryError{z-index:50;background:var(--dsw-alias-bg-layer-1);border-left:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;align-items:flex-start;gap:8px;padding:16px;display:flex;position:fixed;top:0;bottom:0;right:0;overflow:auto}._8Lf9RG_terminalRetry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;border-radius:999px;flex:none;padding:1px 8px}._8Lf9RG_terminalRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_terminalDepsBanner{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);flex-direction:column;flex:none;gap:6px;padding:10px;display:flex}._8Lf9RG_terminalDepsTitle{font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-state-warn-primary)}._8Lf9RG_terminalDepsHint{opacity:.9}._8Lf9RG_terminalDepsCommandRow{align-items:flex-start;gap:8px;display:flex}._8Lf9RG_terminalRepairCommand{white-space:pre-wrap;word-break:break-all;user-select:text;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:4px;flex:1;max-height:160px;margin:0;padding:6px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:1.5;overflow:auto}._8Lf9RG_terminalDepsNote{opacity:.85}._8Lf9RG_terminalDepsActions{align-items:center;gap:8px;display:flex}._8Lf9RG_tabBoundaryError{min-height:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);flex-direction:column;flex:1;align-items:flex-start;gap:8px;padding:12px 16px;display:flex;overflow:auto}._8Lf9RG_nativeTabHost{flex-direction:column;height:100%;min-height:0;display:flex}._8Lf9RG_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}._8Lf9RG_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}._8Lf9RG_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}._8Lf9RG_gitDiffTab{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}._8Lf9RG_gitDiffTabHeader{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}._8Lf9RG_gitDiffTabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-xxs-strong-12);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}._8Lf9RG_producedRow{flex-wrap:wrap;align-items:center;gap:8px;padding:4px 0;display:flex}._8Lf9RG_producedLabel{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._8Lf9RG_producedChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:200px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);cursor:pointer;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;display:inline-flex;overflow:hidden}._8Lf9RG_producedChip:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_producedChip span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._8Lf9RG_producedMore{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary)}._8Lf9RG_toggleButton:focus-visible,._8Lf9RG_bottomClose:focus-visible,._8Lf9RG_iconButton:focus-visible,._8Lf9RG_tab:focus-visible,._8Lf9RG_tabClose:focus-visible,._8Lf9RG_tabBarPlus:focus-visible,._8Lf9RG_paneCard:focus-visible,._8Lf9RG_explorerRow:focus-visible,._8Lf9RG_explorerRef:focus-visible,._8Lf9RG_terminalRetry:focus-visible,._8Lf9RG_editorModeButton:focus-visible,._8Lf9RG_editorDownloadLink:focus-visible,._8Lf9RG_editorPptxButton:focus-visible,._8Lf9RG_editorDocxZoomRange:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){._8Lf9RG_bottomPanel,._8Lf9RG_bottomPanelHidden,._8Lf9RG_toggleButton,._8Lf9RG_tab,._8Lf9RG_tabBarPlus,._8Lf9RG_paneCard,._8Lf9RG_explorerRow,._8Lf9RG_divider,._8Lf9RG_dividerRow:after,._8Lf9RG_dividerCol:after{transition:none;animation:none}}@media (width<=767px){._8Lf9RG_tab{min-width:48px;max-width:128px}}._8Lf9RG_openWithLabel{align-items:center;gap:8px;width:100%;min-width:0;display:flex}._8Lf9RG_openWithName{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}._8Lf9RG_openWithChevron{color:var(--dsw-alias-label-tertiary);flex:none}._8Lf9RG_openWithPin{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);cursor:pointer;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}._8Lf9RG_openWithPin:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_openWithPinActive{color:var(--dsw-alias-state-business-primary)}._8Lf9RG_editorHtmlBlock{margin:8px 0}._8Lf9RG_editorHtmlBlock img,._8Lf9RG_editorHtmlBlock video{max-width:100%}._8Lf9RG_editorHtmlBlock details{margin:4px 0;padding:4px 0}._8Lf9RG_editorHtmlBlock summary{cursor:pointer}._8Lf9RG_tocBar{z-index:7;pointer-events:none;justify-content:flex-end;height:0;display:flex;position:sticky;top:0}._8Lf9RG_tocButton{pointer-events:auto;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:26px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:6px;justify-content:center;align-items:center;margin:4px 2px 0 0;padding:0;display:inline-flex}._8Lf9RG_tocButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_tocPanel{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);width:min(300px,82%);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);pointer-events:auto;border-radius:8px;flex-direction:column;padding:4px;display:flex;position:absolute;top:32px;right:2px;overflow-y:auto}._8Lf9RG_tocItem{min-width:0;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:baseline;gap:8px;padding:4px 8px;display:flex}._8Lf9RG_tocItem:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._8Lf9RG_tocItem[data-level=\"2\"]{padding-left:18px}._8Lf9RG_tocItem[data-level=\"3\"]{padding-left:28px}._8Lf9RG_tocItem[data-level=\"4\"]{padding-left:38px}._8Lf9RG_tocItem[data-level=\"5\"]{padding-left:48px}._8Lf9RG_tocItem[data-level=\"6\"]{padding-left:58px}._8Lf9RG_tocItemLevel{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}._8Lf9RG_tocItemText{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}@keyframes _8Lf9RG_dsh-toc-flash{0%,60%{background:var(--dsw-alias-interactive-bg-hover)}to{background:0 0}}._8Lf9RG_tocFlash{border-radius:4px;animation:1.2s ease-out _8Lf9RG_dsh-toc-flash}";
		...
		var sidebar_module_css_default = {
			"terminalWaitNeedle": "_8Lf9RG_terminalWaitNeedle",
			"tocButton": "_8Lf9RG_tocButton",
			"tocPanel": "_8Lf9RG_tocPanel",
			"paneCard": "_8Lf9RG_paneCard",
			"explorerSymlink": "_8Lf9RG_explorerSymlink",
			"mermaidModalButton": "_8Lf9RG_mermaidModalButton",
			"split": "_8Lf9RG_split",
			"iconButton": "_8Lf9RG_iconButton",
			"editorPathInput": "_8Lf9RG_editorPathInput",
			"browserFrame": "_8Lf9RG_browserFrame",
			"dropDown": "_8Lf9RG_dropDown",
			"editorTreeDock": "_8Lf9RG_editorTreeDock",
			"explorerConfirmDesc": "_8Lf9RG_explorerConfirmDesc",
			"tabBar": "_8Lf9RG_tabBar",
			"tabTitle": "_8Lf9RG_tabTitle",
			"browserBlocked": "_8Lf9RG_browserBlocked",
			"dividerActive": "_8Lf9RG_dividerActive",
			"explorerBroken": "_8Lf9RG_explorerBroken",
			"terminalWaitBanner": "_8Lf9RG_terminalWaitBanner",
			"mermaidInfo": "_8Lf9RG_mermaidInfo",
			"bottomClose": "_8Lf9RG_bottomClose",
			"dropRight": "_8Lf9RG_dropRight",
			"mermaidError": "_8Lf9RG_mermaidError",
			"editorSearchHint": "_8Lf9RG_editorSearchHint",
			"editorCmHidden": "_8Lf9RG_editorCmHidden",
			"explorerActionErrorText": "_8Lf9RG_explorerActionErrorText",
			"browserBlockedDesc": "_8Lf9RG_browserBlockedDesc",
			"sandboxStatus": "_8Lf9RG_sandboxStatus",
			"mermaidModalStage": "_8Lf9RG_mermaidModalStage",
			"terminalDepsNote": "_8Lf9RG_terminalDepsNote",
			"gitEmpty": "_8Lf9RG_gitEmpty",
			"gitDiffTab": "_8Lf9RG_gitDiffTab",
			"openWithPinActive": "_8Lf9RG_openWithPinActive",
			"uploadDropZone": "_8Lf9RG_uploadDropZone",
			"tabActive": "_8Lf9RG_tabActive",
			"explorerEmpty": "_8Lf9RG_explorerEmpty",
			"editor": "_8Lf9RG_editor",
			"dropCenter": "_8Lf9RG_dropCenter",
			"uploadDropHero": "_8Lf9RG_uploadDropHero",
			"uploadOverlayCard": "_8Lf9RG_uploadOverlayCard",
			"editorHtml": "_8Lf9RG_editorHtml",
			"splitChild": "_8Lf9RG_splitChild",
			"editorTreePanel": "_8Lf9RG_editorTreePanel",
			"editorPdfFrameBlocked": "_8Lf9RG_editorPdfFrameBlocked",
			"bottomPanel": "_8Lf9RG_bottomPanel",
			"terminalBanner": "_8Lf9RG_terminalBanner",
			"browserBlockedActions": "_8Lf9RG_browserBlockedActions",
			"editorStatus": "_8Lf9RG_editorStatus",
			"boundaryError": "_8Lf9RG_boundaryError",
			"terminalDepsBanner": "_8Lf9RG_terminalDepsBanner",
			"terminalDepsActions": "_8Lf9RG_terminalDepsActions",
			"editorPptxButton": "_8Lf9RG_editorPptxButton",
			"editorDocxZoomRange": "_8Lf9RG_editorDocxZoomRange",
			"tocItemText": "_8Lf9RG_tocItemText",
			"dsh-toc-flash": "_8Lf9RG_dsh-toc-flash",
			"uploadOverlayCancel": "_8Lf9RG_uploadOverlayCancel",
			"browser": "_8Lf9RG_browser",
			"editorBinaryNotice": "_8Lf9RG_editorBinaryNotice",
			"terminalBannerUrl": "_8Lf9RG_terminalBannerUrl",
			"openWithPin": "_8Lf9RG_openWithPin",
			"pane": "_8Lf9RG_pane",
			"paneTabHidden": "_8Lf9RG_paneTabHidden",
			"explorerRoot": "_8Lf9RG_explorerRoot",
			"explorerRef": "_8Lf9RG_explorerRef",
			"sandboxDot": "_8Lf9RG_sandboxDot",
			"mermaidBody": "_8Lf9RG_mermaidBody",
			"splitCol": "_8Lf9RG_splitCol",
			"mermaidMarkdown": "_8Lf9RG_mermaidMarkdown",
			"openWithLabel": "_8Lf9RG_openWithLabel",
			"explorerActionError": "_8Lf9RG_explorerActionError",
			"editorHtmlBlock": "_8Lf9RG_editorHtmlBlock",
			"uploadOverlay": "_8Lf9RG_uploadOverlay",
			"uploadOverlayProgressFill": "_8Lf9RG_uploadOverlayProgressFill",
			"tabBadge": "_8Lf9RG_tabBadge",
			"bottomResize": "_8Lf9RG_bottomResize",
			"terminal": "_8Lf9RG_terminal",
			"tabList": "_8Lf9RG_tabList",
			"editorPlaceholder": "_8Lf9RG_editorPlaceholder",
			"uploadOverlayStatus": "_8Lf9RG_uploadOverlayStatus",
			"tabBarPlus": "_8Lf9RG_tabBarPlus",
			"orphanedType": "_8Lf9RG_orphanedType",
			"terminalRetry": "_8Lf9RG_terminalRetry",
			"terminalDepsHint": "_8Lf9RG_terminalDepsHint",
			"editorCm": "_8Lf9RG_editorCm",
			"uploadDropZoneText": "_8Lf9RG_uploadDropZoneText",
			"openWithName": "_8Lf9RG_openWithName",
			"tocBar": "_8Lf9RG_tocBar",
			"gitDiffTabHeader": "_8Lf9RG_gitDiffTabHeader",
			"mermaidCopy": "_8Lf9RG_mermaidCopy",
			"dividerCol": "_8Lf9RG_dividerCol",
			"terminalDepsCommandRow": "_8Lf9RG_terminalDepsCommandRow",
			"paneContent": "_8Lf9RG_paneContent",
			"editorPdf": "_8Lf9RG_editorPdf",
			"bottomPanelHidden": "_8Lf9RG_bottomPanelHidden",
			"editorTreeToggleActive": "_8Lf9RG_editorTreeToggleActive",
			"pinnedTab": "_8Lf9RG_pinnedTab",
			"editorPdfDragShieldActive": "_8Lf9RG_editorPdfDragShieldActive",
			"explorerBody": "_8Lf9RG_explorerBody",
			"uploadDropChatCard": "_8Lf9RG_uploadDropChatCard",
			"explorerCopied": "_8Lf9RG_explorerCopied",
			"dirtyDot": "_8Lf9RG_dirtyDot",
			"dropUp": "_8Lf9RG_dropUp",
			"explorerRenameInput": "_8Lf9RG_explorerRenameInput",
			"editorTreeResize": "_8Lf9RG_editorTreeResize",
			"producedRow": "_8Lf9RG_producedRow",
			"divider": "_8Lf9RG_divider",
			"editorHeader": "_8Lf9RG_editorHeader",
			"splitRow": "_8Lf9RG_splitRow",
			"editorPdfToolbar": "_8Lf9RG_editorPdfToolbar",
			"workbench": "_8Lf9RG_workbench",
			"paneTab": "_8Lf9RG_paneTab",
			"dsh-row-in": "_8Lf9RG_dsh-row-in",
			"explorerRowDropTarget": "_8Lf9RG_explorerRowDropTarget",
			"editorSearchResult": "_8Lf9RG_editorSearchResult",
			"tab": "_8Lf9RG_tab",
			"browserStart": "_8Lf9RG_browserStart",
			"browserBlockedTitle": "_8Lf9RG_browserBlockedTitle",
			"uploadDropZonePill": "_8Lf9RG_uploadDropZonePill",
			"mermaidModalToolbar": "_8Lf9RG_mermaidModalToolbar",
			"panel": "_8Lf9RG_panel",
			"bottomResizeActive": "_8Lf9RG_bottomResizeActive",
			"dropLeft": "_8Lf9RG_dropLeft",
			"panelBody": "_8Lf9RG_panelBody",
			"fenceError": "_8Lf9RG_fenceError",
			"editorImage": "_8Lf9RG_editorImage",
			"explorerName": "_8Lf9RG_explorerName",
			"mermaidWrap": "_8Lf9RG_mermaidWrap",
			"mermaidModal": "_8Lf9RG_mermaidModal",
			"editorPdfDragShield": "_8Lf9RG_editorPdfDragShield",
			"chipIcon": "_8Lf9RG_chipIcon",
			"terminalRepairCommand": "_8Lf9RG_terminalRepairCommand",
			"dropOverlay": "_8Lf9RG_dropOverlay",
			"explorerRow": "_8Lf9RG_explorerRow",
			"editorBinary": "_8Lf9RG_editorBinary",
			"uploadOverlayTitle": "_8Lf9RG_uploadOverlayTitle",
			"browserBlockedButton": "_8Lf9RG_browserBlockedButton",
			"tabBoundaryError": "_8Lf9RG_tabBoundaryError",
			"producedLabel": "_8Lf9RG_producedLabel",
			"mermaidModalHint": "_8Lf9RG_mermaidModalHint",
			"explorerRenaming": "_8Lf9RG_explorerRenaming",
			"editorSearchInput": "_8Lf9RG_editorSearchInput",
			"editorError": "_8Lf9RG_editorError",
			"sandboxStatusOn": "_8Lf9RG_sandboxStatusOn",
			"browserBar": "_8Lf9RG_browserBar",
			"dividerRow": "_8Lf9RG_dividerRow",
			"editorStatusError": "_8Lf9RG_editorStatusError",
			"terminalDepsTitle": "_8Lf9RG_terminalDepsTitle",
			"mermaidCode": "_8Lf9RG_mermaidCode",
			"producedMore": "_8Lf9RG_producedMore",
			"explorerRowRevealed": "_8Lf9RG_explorerRowRevealed",
			"explorerHidden": "_8Lf9RG_explorerHidden",
			"editorImageWrap": "_8Lf9RG_editorImageWrap",
			"editorPdfStage": "_8Lf9RG_editorPdfStage",
			"editorTitle": "_8Lf9RG_editorTitle",
			"openWithChevron": "_8Lf9RG_openWithChevron",
			"browserMessage": "_8Lf9RG_browserMessage",
			"tocItemLevel": "_8Lf9RG_tocItemLevel",
			"toggleButton": "_8Lf9RG_toggleButton",
			"paneDrop": "_8Lf9RG_paneDrop",
			"editorTreeSearch": "_8Lf9RG_editorTreeSearch",
			"editorBanner": "_8Lf9RG_editorBanner",
			"explorerDir": "_8Lf9RG_explorerDir",
			"editorModeActive": "_8Lf9RG_editorModeActive",
			"sandboxStatusOff": "_8Lf9RG_sandboxStatusOff",
			"nativeTabHost": "_8Lf9RG_nativeTabHost",
			"terminalWrap": "_8Lf9RG_terminalWrap",
			"editorMain": "_8Lf9RG_editorMain",
			"editorTreePanelFull": "_8Lf9RG_editorTreePanelFull",
			"editorModeToggle": "_8Lf9RG_editorModeToggle",
			"gitError": "_8Lf9RG_gitError",
			"uploadOverlayProgress": "_8Lf9RG_uploadOverlayProgress",
			"sandboxStatusText": "_8Lf9RG_sandboxStatusText",
			"browserInput": "_8Lf9RG_browserInput",
			"explorerHeader": "_8Lf9RG_explorerHeader",
			"sandboxAction": "_8Lf9RG_sandboxAction",
			"editorPdfFrame": "_8Lf9RG_editorPdfFrame",
			"tocItem": "_8Lf9RG_tocItem",
			"tabClose": "_8Lf9RG_tabClose",
			"editorMd": "_8Lf9RG_editorMd",
			"gitDiffTabTitle": "_8Lf9RG_gitDiffTabTitle",
			"editorModeButton": "_8Lf9RG_editorModeButton",
			"editorBody": "_8Lf9RG_editorBody",
			"mermaidHeader": "_8Lf9RG_mermaidHeader",
			"selectionPopup": "_8Lf9RG_selectionPopup",
			"paneEmptyCards": "_8Lf9RG_paneEmptyCards",
			"explorerError": "_8Lf9RG_explorerError",
			"producedChip": "_8Lf9RG_producedChip",
			"tocFlash": "_8Lf9RG_tocFlash",
			"explorer": "_8Lf9RG_explorer",
			"editorDownloadLink": "_8Lf9RG_editorDownloadLink",
			"explorerActionErrorClose": "_8Lf9RG_explorerActionErrorClose",
			"uploadDropChatHint": "_8Lf9RG_uploadDropChatHint",
			"gitPlaceholder": "_8Lf9RG_gitPlaceholder",
			"tabBarDrop": "_8Lf9RG_tabBarDrop"
		};
		//#endregion
		//#region src/client/intercept.tsx
		/**
		* Interception of the chat's produced-files row: the turn-tail list entry
		* that adds sidebar-openable chips for the files the closing turn produced,
		* alongside the built-in deliverables entry. The chips open the file in the
		* sidebar instead of the host OS. The entry computes its own match and
		* renders nothing when the turn produced no files.
		*/
		...
		*/
		...
		function SidebarProducedFiles(props) {
			const { openInSidebar, onShowInFolder, store } = props;
		...
		*/
		function sessionAbsolutePath(scope, path) {
		...
		*  `Content-Disposition: attachment`, so the browser saves the file. */
		...
		function fileUrl(scope, path, download) {
			const params = new URLSearchParams({
				sessionId: scope.sessionId,
				path: sessionAbsolutePath(scope, path)
			});
			if (scope.cwd !== void 0 && scope.cwd !== "") params.set("cwd", scope.cwd);
		...
		*  base name, matching how openFile titles editor tabs). */
		function retargetPathTabs(ctx, oldPath, newPath) {
			const service = ctx.get("betterSidebar");
			if (service === void 0) return;
			for (const tab of pathTabsOf(service.listOpenTabs())) if (tab.path === oldPath) service.updateTab(tab.id, {
				path: newPath,
		...
		*  subtree of open files with it). */
		function closePathTabs(ctx, target) {
			const service = ctx.get("betterSidebar");
			if (service === void 0) return;
		...
		function EditorHost(props) {
			...
			*/
			const openFile = (absolute) => {
				if (inPlace && !isDir) ctx.get("betterSidebar")?.updateTab(tab.id, {
					path: absolute,
			...
			*  when the same file is already open (the native surface would focus it). */
			const openFileNewTab = (absolute) => {
				const service = ctx.get("betterSidebar");
				if (service !== void 0 && service.native) {
					service.openTab({
						type: "editor",
						title: baseName(absolute),
						path: absolute,
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\SideCardSection.module.css.mjs
		const css$5 = ".adWtrW_section{flex-direction:column;gap:16px;width:100%;max-width:760px;display:flex}.adWtrW_intro{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 2px;font-size:13px;line-height:20px}.adWtrW_group{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:16px;flex-direction:column;flex:none;gap:8px;padding:20px;display:flex}.adWtrW_groupHeading{color:var(--dsw-alias-label-primary);align-items:baseline;gap:7px;padding:0 2px 6px;font-size:13px;font-weight:600;line-height:20px;display:flex}.adWtrW_count{background:var(--dsw-alias-accent-soft,var(--dsw-alias-bg-layer-2));color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:16px}.adWtrW_grid{grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:12px;display:grid}.adWtrW_card{border:1px solid var(--dsw-alias-border-l2);min-height:106px;font:inherit;color:inherit;cursor:pointer;background:0 0;border-radius:12px;flex-direction:column;transition:background .12s,border-color .12s;display:flex;position:relative;overflow:hidden}.adWtrW_card:not(.adWtrW_cardOn):hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-label-dimmed)}.adWtrW_cardOn{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 45%, transparent);background:var(--dsw-alias-interactive-bg-active)}.adWtrW_cardMain{border-radius:inherit;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;flex:1;gap:6px;padding:12px;display:flex}.adWtrW_cardMain:focus-visible,.adWtrW_cardSettings:focus-visible,.adWtrW_rowGear:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.adWtrW_cardTop{align-items:center;gap:8px;min-width:0;min-height:28px;display:flex}.adWtrW_cardIconChip{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:28px;height:28px;color:var(--dsw-alias-label-tertiary);border-radius:8px;flex:none;justify-content:center;align-items:center;display:inline-flex}.adWtrW_cardOn .adWtrW_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);background:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 12%, transparent);color:var(--dsw-alias-button-primary-fill)}.adWtrW_cardTitle{min-width:0;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;flex:1;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.adWtrW_cardOn .adWtrW_cardTitle{color:var(--dsw-alias-label-primary)}.adWtrW_cardSwitch{flex:none;align-items:center;display:inline-flex}.adWtrW_cardSwitchTrack{box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;align-items:center;width:30px;height:16px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}.adWtrW_cardSwitchThumb{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:10px;height:10px;transition:transform .15s,background .15s;display:block}.adWtrW_cardOn .adWtrW_cardSwitchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}.adWtrW_cardOn .adWtrW_cardSwitchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(14px)}.adWtrW_cardDesc{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:11px;line-height:16px;overflow:hidden}.adWtrW_addCard{border-style:dashed;border-color:var(--dsw-alias-border-l2);text-align:left;align-items:flex-start;padding:12px}.adWtrW_addCard:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.adWtrW_addCard:hover .adWtrW_cardTitle{color:var(--dsw-alias-label-primary)}.adWtrW_addCard:hover .adWtrW_cardIconChip{border-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 35%, transparent);color:var(--dsw-alias-button-primary-fill)}.adWtrW_addCard:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:2px}.adWtrW_cardOn .adWtrW_cardDesc{color:var(--dsw-alias-label-secondary)}.adWtrW_cardSettings{border:0;border-top:1px solid var(--dsw-alias-border-l1);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;cursor:pointer;background:0 0;align-items:center;gap:6px;padding:6px 12px;font-size:11px;font-weight:500;line-height:16px;transition:background .12s,color .12s;display:flex}.adWtrW_cardOn .adWtrW_cardSettings{border-top-color:color-mix(in srgb, var(--dsw-alias-button-primary-fill) 18%, transparent)}.adWtrW_cardSettings:hover{background:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-brand-primary)}.adWtrW_rowGear{border:1px solid var(--dsw-alias-border-l2);width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;transition:background .12s,border-color .12s,color .12s;display:inline-flex}.adWtrW_rowGear:hover{border-color:var(--dsw-alias-interactive-bg-hover-accent);background:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-brand-primary)}.adWtrW_row{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding:12px 2px;display:flex}.adWtrW_row:last-child{border-bottom:none}.adWtrW_rowText{flex-direction:column;gap:4px;min-width:0;display:flex}.adWtrW_title{color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.adWtrW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.adWtrW_switch{cursor:pointer;flex:none;display:inline-flex;position:relative}.adWtrW_switchInput{opacity:0;width:1px;height:1px;margin:0;position:absolute}.adWtrW_switchTrack{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:10px;align-items:center;width:36px;height:20px;padding:2px;transition:background .15s,border-color .15s;display:inline-flex}.adWtrW_switchThumb{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:14px;height:14px;transition:transform .15s,background .15s;display:block}.adWtrW_switch:hover .adWtrW_switchTrack{border-color:var(--dsw-alias-label-dimmed)}.adWtrW_switchInput:checked+.adWtrW_switchTrack{border-color:var(--dsw-alias-button-primary-fill);background:var(--dsw-alias-button-primary-fill)}.adWtrW_switchInput:checked+.adWtrW_switchTrack .adWtrW_switchThumb{background:var(--dsw-alias-bg-layer-3);transform:translate(16px)}.adWtrW_switchInput:focus-visible+.adWtrW_switchTrack{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.adWtrW_control{flex:none;align-items:center;gap:6px;display:flex}.adWtrW_percentInput{width:76px}.adWtrW_typedInput{width:200px}.adWtrW_typedInputNumber{width:76px}.adWtrW_selectAnchor{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);max-width:220px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:8px;align-items:center;gap:6px;padding:4px 8px;font-size:13px;line-height:20px;display:flex}.adWtrW_selectAnchor:hover{border-color:var(--dsw-alias-label-dimmed)}.adWtrW_selectAnchorIcon{flex:none;display:inline-flex}.adWtrW_selectAnchorText{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.adWtrW_selectOption{align-items:center;gap:10px;min-width:200px;display:flex}.adWtrW_selectOptionIcon{color:var(--dsw-alias-label-secondary);flex:none;display:inline-flex}.adWtrW_selectOptionText{flex-direction:column;min-width:0;display:flex}.adWtrW_suffix{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.adWtrW_cssTextArea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:100%;min-height:120px;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);resize:vertical;border-radius:8px;padding:8px 10px;font-size:12px;line-height:1.6}.adWtrW_cssTextArea:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.adWtrW_popupDialog.adWtrW_popupDialog{width:min(460px,100%)}.adWtrW_popupRows{box-sizing:border-box;scrollbar-width:thin;scrollbar-color:var(--dsw-alias-scrollbar-bg-l2,transparent) transparent;flex-direction:column;gap:8px;width:100%;max-height:min(52vh,440px);padding-right:4px;display:flex;overflow:hidden auto}.adWtrW_popupRows::-webkit-scrollbar{width:6px}.adWtrW_popupRows::-webkit-scrollbar-thumb{background:var(--dsw-alias-scrollbar-bg-l2,var(--dsw-alias-border-l2));border-radius:3px}.adWtrW_popupRows::-webkit-scrollbar-thumb:hover{background:var(--dsw-alias-scrollbar-hover-l2,var(--dsw-alias-label-dimmed))}.adWtrW_popupRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex:none;justify-content:space-between;align-items:center;gap:16px;min-width:0;padding:12px 14px;transition:border-color .16s,background .16s;display:flex}.adWtrW_popupRow:hover{border-color:var(--dsw-alias-label-dimmed)}.adWtrW_done{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.adWtrW_done:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}.adWtrW_error{color:var(--dsw-alias-state-error-primary);padding:10px 0 2px;font-size:12px;line-height:17px}.adWtrW_pluginModal.adWtrW_pluginModal{width:min(560px,100%)}.adWtrW_pluginList{flex-direction:column;gap:12px;width:100%;display:flex}.adWtrW_pluginTopicBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:8px;padding:6px 12px;font-size:12px;line-height:18px}.adWtrW_pluginTopicBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.adWtrW_pluginTopicBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.adWtrW_pluginEmpty{color:var(--dsw-alias-label-tertiary);padding:20px 2px;font-size:12px;line-height:18px}.adWtrW_pluginEntry{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;gap:4px;padding:12px;display:flex}.adWtrW_pluginEntryHead{justify-content:space-between;align-items:center;gap:12px;display:flex}.adWtrW_pluginEntryActions{flex:none;align-items:center;gap:6px;display:inline-flex}.adWtrW_pluginJumpBtn{appearance:none;border:1px solid var(--dsw-alias-border-l2);font:inherit;cursor:pointer;color:var(--dsw-alias-label-secondary);background:0 0;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.adWtrW_pluginJumpBtn:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-interactive-bg-hover-accent);color:var(--dsw-alias-label-primary)}.adWtrW_pluginJumpBtn:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.adWtrW_pluginName{appearance:none;min-width:0;font:inherit;color:var(--dsw-alias-label-primary);text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-size:13px;font-weight:600;line-height:20px;text-decoration:none;overflow:hidden}.adWtrW_pluginName:hover{color:var(--dsw-alias-button-primary-fill);text-decoration:underline}.adWtrW_pluginDesc{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.adWtrW_pluginInstall{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);white-space:nowrap;border-radius:8px;padding:6px 10px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px;display:block;overflow-x:auto}.adWtrW_pluginCopyBtn{appearance:none;font:inherit;cursor:pointer;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);border:1px solid #0000;border-radius:8px;flex:none;padding:3px 12px;font-size:12px;line-height:1.5}.adWtrW_pluginCopyBtn:hover{background:var(--dsw-alias-button-primary-hover)}.adWtrW_pluginCopyBtn:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}@media (prefers-reduced-motion:reduce){.adWtrW_card,.adWtrW_cardSettings,.adWtrW_cardSwitchTrack,.adWtrW_cardSwitchThumb,.adWtrW_rowGear,.adWtrW_popupRow,.adWtrW_switchTrack,.adWtrW_switchThumb{transition:none}}.adWtrW_versionBadge{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:999px;align-self:flex-start;align-items:center;gap:8px;padding:4px 12px 4px 14px;font-size:12px;line-height:18px;display:inline-flex}.adWtrW_versionBadgeName{color:var(--dsw-alias-label-primary);font-weight:600}.adWtrW_versionBadgeTag{background:var(--dsw-alias-accent-soft,var(--dsw-alias-border-l2));color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;padding:1px 8px}.adWtrW_pluginSearch{box-sizing:border-box;appearance:none;border:1px solid var(--dsw-alias-border-l2);width:100%;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:8px;padding:6px 10px;font-size:12px;line-height:18px}.adWtrW_pluginSearch::placeholder{color:var(--dsw-alias-label-tertiary)}.adWtrW_pluginSearch:focus-visible{outline:2px solid var(--dsw-alias-border-l4);outline-offset:1px}.adWtrW_pluginEntries{flex-direction:column;gap:10px;max-height:46vh;padding-right:2px;display:flex;overflow:hidden auto}.adWtrW_pluginGroup{flex-direction:column;gap:8px;display:flex}.adWtrW_pluginGroupHeading{color:var(--dsw-alias-label-secondary);padding:2px 2px 0;font-size:12px;font-weight:600;line-height:18px}.adWtrW_openWithEditorRow{grid-template-columns:1fr 1.5fr auto auto;align-items:center;gap:8px;min-width:0;display:grid}.adWtrW_openWithEditorInput,.adWtrW_openWithEditorTemplate{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;padding:5px 8px;font-size:13px;line-height:20px}.adWtrW_openWithEditorInput:focus-visible,.adWtrW_openWithEditorTemplate:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.adWtrW_openWithFamily{color:var(--dsw-alias-label-secondary);white-space:nowrap;cursor:pointer;align-items:center;gap:5px;font-size:12px;display:inline-flex}.adWtrW_openWithRemove{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:8px;justify-content:center;align-items:center;padding:4px;display:inline-flex}.adWtrW_openWithRemove:hover{color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-bg-layer-2)}.adWtrW_openWithHint{color:var(--dsw-alias-state-error-primary);padding:0 2px;font-size:12px;line-height:17px}";
		...
		var SideCardSection_module_css_default = {
			"cardDesc": "adWtrW_cardDesc",
			"openWithEditorTemplate": "adWtrW_openWithEditorTemplate",
			"openWithFamily": "adWtrW_openWithFamily",
			"popupDialog": "adWtrW_popupDialog",
			"rowGear": "adWtrW_rowGear",
			"switch": "adWtrW_switch",
			"switchThumb": "adWtrW_switchThumb",
			"selectOption": "adWtrW_selectOption",
			"cardSwitchTrack": "adWtrW_cardSwitchTrack",
			"pluginEntry": "adWtrW_pluginEntry",
			"title": "adWtrW_title",
			"openWithRemove": "adWtrW_openWithRemove",
			"done": "adWtrW_done",
			"desc": "adWtrW_desc",
			"cardMain": "adWtrW_cardMain",
			"addCard": "adWtrW_addCard",
			"control": "adWtrW_control",
			"pluginTopicBtn": "adWtrW_pluginTopicBtn",
			"suffix": "adWtrW_suffix",
			"cardSettings": "adWtrW_cardSettings",
			"pluginEmpty": "adWtrW_pluginEmpty",
			"pluginEntryHead": "adWtrW_pluginEntryHead",
			"pluginEntryActions": "adWtrW_pluginEntryActions",
			"count": "adWtrW_count",
			"cardSwitchThumb": "adWtrW_cardSwitchThumb",
			"row": "adWtrW_row",
			"grid": "adWtrW_grid",
			"selectAnchorText": "adWtrW_selectAnchorText",
			"pluginName": "adWtrW_pluginName",
			"versionBadge": "adWtrW_versionBadge",
			"pluginEntries": "adWtrW_pluginEntries",
			"selectAnchorIcon": "adWtrW_selectAnchorIcon",
			"selectOptionIcon": "adWtrW_selectOptionIcon",
			"intro": "adWtrW_intro",
			"pluginModal": "adWtrW_pluginModal",
			"cardTitle": "adWtrW_cardTitle",
			"groupHeading": "adWtrW_groupHeading",
			"error": "adWtrW_error",
			"popupRow": "adWtrW_popupRow",
			"card": "adWtrW_card",
			"cssTextArea": "adWtrW_cssTextArea",
			"popupRows": "adWtrW_popupRows",
			"percentInput": "adWtrW_percentInput",
			"pluginInstall": "adWtrW_pluginInstall",
			"pluginDesc": "adWtrW_pluginDesc",
			"group": "adWtrW_group",
			"switchInput": "adWtrW_switchInput",
			"typedInput": "adWtrW_typedInput",
			"cardTop": "adWtrW_cardTop",
			"pluginCopyBtn": "adWtrW_pluginCopyBtn",
			"pluginList": "adWtrW_pluginList",
			"switchTrack": "adWtrW_switchTrack",
			"section": "adWtrW_section",
			"typedInputNumber": "adWtrW_typedInputNumber",
			"cardSwitch": "adWtrW_cardSwitch",
			"versionBadgeTag": "adWtrW_versionBadgeTag",
			"pluginSearch": "adWtrW_pluginSearch",
			"cardIconChip": "adWtrW_cardIconChip",
			"openWithEditorRow": "adWtrW_openWithEditorRow",
			"pluginGroupHeading": "adWtrW_pluginGroupHeading",
			"openWithEditorInput": "adWtrW_openWithEditorInput",
			"rowText": "adWtrW_rowText",
			"cardOn": "adWtrW_cardOn",
			"pluginJumpBtn": "adWtrW_pluginJumpBtn",
			"versionBadgeName": "adWtrW_versionBadgeName",
			"selectAnchor": "adWtrW_selectAnchor",
			"selectOptionText": "adWtrW_selectOptionText",
			"pluginGroup": "adWtrW_pluginGroup",
			"openWithHint": "adWtrW_openWithHint"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\changes\changes.module.css.mjs
		const css$4 = ".GG_xKG_root{background:var(--dsw-alias-bg-base);height:100%;min-height:0;color:var(--dsw-alias-label-primary);flex-direction:column;font-size:12px;display:flex}.GG_xKG_lensBar{flex:none;align-items:center;padding:8px 8px 4px 12px;display:flex}.GG_xKG_lensSwitch{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;gap:2px;padding:2px;display:inline-flex}.GG_xKG_lensButton{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:2px 10px}.GG_xKG_lensButton:hover{color:var(--dsw-alias-label-primary)}.GG_xKG_lensButton[data-active=true]{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary)}.GG_xKG_git{flex-direction:column;flex:1;min-width:0;min-height:0;display:flex;overflow:hidden auto}.GG_xKG_gitHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.GG_xKG_gitWorktreeRow{flex:none;align-items:center;gap:8px;padding:6px 8px 0 12px;display:flex}.GG_xKG_gitWorktreeLabel{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xxxs-11);flex:none}.GG_xKG_gitBranchSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);border-radius:6px;flex:1;padding:0 6px}.GG_xKG_gitSection{border-top:1px solid var(--dsw-alias-border-l1)}.GG_xKG_gitSectionHeader{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);text-transform:uppercase;justify-content:space-between;align-items:center;padding:6px 12px 4px;display:flex}.GG_xKG_gitLink{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:none;padding:0}.GG_xKG_gitLink:hover:not(:disabled){text-decoration:underline}.GG_xKG_gitLink:disabled{opacity:.4;cursor:default}.GG_xKG_gitRow{min-height:34px;animation:GG_xKG_dsh-row-in .15s var(--ds-ease-in-out);border-radius:8px;align-items:center;gap:6px;margin:0 6px;padding:0 8px;display:flex}.GG_xKG_gitRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.GG_xKG_gitRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.GG_xKG_gitRowMain{cursor:pointer;text-align:left;background:0 0;border:none;flex:1;align-items:center;gap:8px;min-width:0;padding:3px 0;display:flex}.GG_xKG_gitBadge{width:20px;height:16px;font:var(--dsw-font-xxxs-strong-11);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;justify-content:center;align-items:center;display:inline-flex}.GG_xKG_gitBadge[data-letter=A],.GG_xKG_gitBadge[data-letter=\\?]{color:var(--dsw-alias-state-success-primary)}.GG_xKG_gitBadge[data-letter=D]{color:var(--dsw-alias-state-error-primary)}.GG_xKG_gitBadge[data-letter=M],.GG_xKG_gitBadge[data-letter=R]{color:var(--dsw-alias-state-business-primary)}.GG_xKG_gitBadge[data-letter=C],.GG_xKG_gitBadge[data-letter=U]{color:var(--dsw-alias-state-warn-primary)}.GG_xKG_gitName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.GG_xKG_gitEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);padding:4px 12px 8px}.GG_xKG_gitPlaceholder{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;padding:16px}.GG_xKG_gitError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);white-space:pre-wrap;padding:8px 12px}.GG_xKG_gitConfirmDesc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);white-space:pre-wrap;margin:0}.GG_xKG_gitCommit{border-top:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:8px 12px;display:flex}.GG_xKG_gitCommitInput{flex:1;min-width:0}.GG_xKG_gitCommitButton{background:var(--dsw-alias-button-primary-fill);height:26px;color:var(--dsw-alias-label-primary-inverted);font:var(--dsw-font-xxs-strong-12);cursor:pointer;border:none;border-radius:6px;flex:none;padding:0 12px}.GG_xKG_gitCommitButton:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.GG_xKG_gitCommitButton:disabled{opacity:.45;cursor:default}.GG_xKG_gitLogRow{cursor:pointer;border-radius:8px;flex-direction:column;gap:2px;padding:5px 12px;display:flex}.GG_xKG_gitLogRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.GG_xKG_gitLogRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.GG_xKG_gitLogLine1{align-items:baseline;gap:8px;min-width:0;display:flex}.GG_xKG_gitLogHash{font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-tertiary);flex:none}.GG_xKG_gitLogLine2{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;display:flex}.GG_xKG_gitLogRef{border:1px solid var(--dsw-alias-border-l2);font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-brand-primary);white-space:nowrap;border-radius:999px;flex:none;padding:0 5px}.GG_xKG_gitLogSubject{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.GG_xKG_gitLogMeta{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.GG_xKG_gitLogMore{border:1px solid var(--dsw-alias-border-l2);width:calc(100% - 24px);font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;margin:4px 12px 8px;padding:6px 0;display:block}.GG_xKG_gitLogMore:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.GG_xKG_gitLogMore:disabled{opacity:.5;cursor:default}.GG_xKG_session{flex-direction:column;flex:1;min-height:0;display:flex}.GG_xKG_filterRow{flex-wrap:wrap;flex:none;gap:4px;padding:2px 8px 6px 12px;display:flex}.GG_xKG_filterChip{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-11);cursor:pointer;background:0 0;border-radius:999px;padding:1px 8px}.GG_xKG_filterChip:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.GG_xKG_filterChip[data-active=true]{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary);border-color:#0000}.GG_xKG_sessionList{flex:1;min-height:0;padding:0 6px 10px;overflow-y:auto}.GG_xKG_empty{color:var(--dsw-alias-label-tertiary);text-align:center;padding:24px 8px}.GG_xKG_loadError{border-left:3px solid var(--dsw-alias-state-warn-primary);color:var(--dsw-alias-label-secondary);border-radius:0 6px 6px 0;margin:4px 8px;padding:6px 10px;font-size:11px}.GG_xKG_fileGroup{margin-bottom:6px}.GG_xKG_filePath{color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code,monospace);word-break:break-all;padding:6px 4px 2px;font-size:11px;display:block}.GG_xKG_fileGroup:first-child .GG_xKG_filePath{padding-top:2px}.GG_xKG_opRow{width:100%;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;text-align:left;background:0 0;border:0;border-radius:6px;align-items:center;gap:6px;padding:3px 5px;font-size:11px;display:flex}.GG_xKG_opRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.GG_xKG_opRow[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.GG_xKG_opRow[data-op-error=true]{box-shadow:inset 2px 0 0 var(--dsw-alias-state-error-primary)}.GG_xKG_opKind{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.GG_xKG_opKind[data-kind=write]{color:var(--dsw-alias-state-success-primary)}.GG_xKG_opKind[data-kind=edit]{color:var(--dsw-alias-state-business-primary)}.GG_xKG_opMeta{flex:none;align-items:baseline;gap:8px;min-width:0;margin-left:auto;display:inline-flex}.GG_xKG_opTime{color:var(--dsw-alias-label-tertiary);flex:none;font-size:10px}.GG_xKG_opFlag{color:var(--dsw-alias-state-business-primary);flex:none;font-size:10px}.GG_xKG_opFlagError{color:var(--dsw-alias-state-error-primary);flex:none;font-size:10px}.GG_xKG_opSize{color:var(--dsw-alias-label-tertiary);font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none}.GG_xKG_redactBanner{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-state-warn-primary);background:var(--dsw-alias-interactive-bg-hover);white-space:nowrap;border-radius:7px;flex:none;padding:2px 8px}.GG_xKG_mdToggle{border:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border-radius:7px;flex:none;padding:2px 8px}.GG_xKG_mdToggle:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.GG_xKG_mdToggle[data-on=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.GG_xKG_mdBody{font:var(--dsw-font-xs-regular-13);min-height:0;padding:12px 16px 20px;line-height:1.6;overflow-y:auto}.GG_xKG_htmlPane{flex:1;min-height:0;display:flex}.GG_xKG_htmlFrame{background:var(--dsw-alias-bg-base);border:none;flex:1;width:100%}.GG_xKG_diffPane{border-top:1px solid var(--dsw-alias-border-l1);flex-direction:column;flex:none;min-height:0;display:flex}.GG_xKG_dragHandle{cursor:ns-resize;background:var(--dsw-alias-bg-base);flex:none;height:8px;position:relative}.GG_xKG_dragHandle:after{content:\"\";background:var(--dsw-alias-border-l2);border-radius:1px;width:36px;height:2px;position:absolute;top:3px;left:calc(50% - 18px)}.GG_xKG_dragHandle:hover:after,.GG_xKG_dragHandle:focus-visible:after{background:var(--dsw-alias-state-business-primary)}.GG_xKG_diffHead{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;padding:3px 8px 3px 10px;display:flex}.GG_xKG_diffKind{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.GG_xKG_diffKind[data-kind=git]{color:var(--dsw-alias-brand-primary)}.GG_xKG_diffKind[data-kind=write]{color:var(--dsw-alias-state-success-primary)}.GG_xKG_diffKind[data-kind=edit]{color:var(--dsw-alias-state-business-primary)}.GG_xKG_diffPath{font-family:var(--ds-font-family-code,monospace);white-space:nowrap;text-overflow:ellipsis;color:var(--dsw-alias-label-primary);direction:rtl;flex:1;min-width:0;font-size:11px;overflow:hidden}.GG_xKG_diffStats{font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none;gap:5px;display:inline-flex}.GG_xKG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.GG_xKG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.GG_xKG_iconButton:disabled{opacity:.4;cursor:default}.GG_xKG_paneBody{flex:1;min-height:0;overflow-y:auto}.GG_xKG_readError{color:var(--dsw-alias-state-error-primary);border-left:3px solid var(--dsw-alias-state-error-primary);white-space:pre-wrap;word-break:break-word;border-radius:0 6px 6px 0;margin:6px 8px;padding:6px 10px}.GG_xKG_priorUnknown{color:var(--dsw-alias-label-tertiary);padding:3px 10px;font-size:10px}@keyframes GG_xKG_dsh-row-in{0%{opacity:0}}.GG_xKG_gitLink:focus-visible,.GG_xKG_gitRowMain:focus-visible,.GG_xKG_gitLogRow:focus-visible,.GG_xKG_gitCommitButton:focus-visible,.GG_xKG_gitLogMore:focus-visible,.GG_xKG_gitBranchSelect:focus-visible,.GG_xKG_lensButton:focus-visible,.GG_xKG_filterChip:focus-visible,.GG_xKG_iconButton:focus-visible,.GG_xKG_dragHandle:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.GG_xKG_gitRow{animation:none}}";
		...
		var changes_module_css_default = {
			"gitRow": "GG_xKG_gitRow",
			"diffHead": "GG_xKG_diffHead",
			"gitBadge": "GG_xKG_gitBadge",
			"filterChip": "GG_xKG_filterChip",
			"empty": "GG_xKG_empty",
			"session": "GG_xKG_session",
			"gitPlaceholder": "GG_xKG_gitPlaceholder",
			"fileGroup": "GG_xKG_fileGroup",
			"gitSection": "GG_xKG_gitSection",
			"gitLogLine1": "GG_xKG_gitLogLine1",
			"root": "GG_xKG_root",
			"priorUnknown": "GG_xKG_priorUnknown",
			"gitBranchSelect": "GG_xKG_gitBranchSelect",
			"gitHeader": "GG_xKG_gitHeader",
			"opRow": "GG_xKG_opRow",
			"diffPath": "GG_xKG_diffPath",
			"readError": "GG_xKG_readError",
			"mdBody": "GG_xKG_mdBody",
			"opFlagError": "GG_xKG_opFlagError",
			"opTime": "GG_xKG_opTime",
			"sessionList": "GG_xKG_sessionList",
			"diffPane": "GG_xKG_diffPane",
			"gitLink": "GG_xKG_gitLink",
			"opMeta": "GG_xKG_opMeta",
			"gitWorktreeLabel": "GG_xKG_gitWorktreeLabel",
			"opSize": "GG_xKG_opSize",
			"diffKind": "GG_xKG_diffKind",
			"iconButton": "GG_xKG_iconButton",
			"mdToggle": "GG_xKG_mdToggle",
			"dsh-row-in": "GG_xKG_dsh-row-in",
			"git": "GG_xKG_git",
			"gitWorktreeRow": "GG_xKG_gitWorktreeRow",
			"gitLogHash": "GG_xKG_gitLogHash",
			"gitCommitButton": "GG_xKG_gitCommitButton",
			"gitEmpty": "GG_xKG_gitEmpty",
			"gitConfirmDesc": "GG_xKG_gitConfirmDesc",
			"gitLogRow": "GG_xKG_gitLogRow",
			"lensBar": "GG_xKG_lensBar",
			"gitLogSubject": "GG_xKG_gitLogSubject",
			"htmlPane": "GG_xKG_htmlPane",
			"opKind": "GG_xKG_opKind",
			"diffStats": "GG_xKG_diffStats",
			"gitCommitInput": "GG_xKG_gitCommitInput",
			"loadError": "GG_xKG_loadError",
			"htmlFrame": "GG_xKG_htmlFrame",
			"gitLogMeta": "GG_xKG_gitLogMeta",
			"gitLogMore": "GG_xKG_gitLogMore",
			"filterRow": "GG_xKG_filterRow",
			"filePath": "GG_xKG_filePath",
			"lensButton": "GG_xKG_lensButton",
			"gitLogRef": "GG_xKG_gitLogRef",
			"lensSwitch": "GG_xKG_lensSwitch",
			"redactBanner": "GG_xKG_redactBanner",
			"dragHandle": "GG_xKG_dragHandle",
			"gitCommit": "GG_xKG_gitCommit",
			"opFlag": "GG_xKG_opFlag",
			"gitSectionHeader": "GG_xKG_gitSectionHeader",
			"paneBody": "GG_xKG_paneBody",
			"gitName": "GG_xKG_gitName",
			"gitError": "GG_xKG_gitError",
			"gitRowMain": "GG_xKG_gitRowMain",
			"gitLogLine2": "GG_xKG_gitLogLine2"
		};
		//#endregion
			...
			const renderEntry = (entry, staged) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: staged ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutlineRegular, { size: 16 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutlineRegular, { size: 16 })
					})]
  ...
  void while with yield`;
    ...
    repeat return then true until while`)
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\diff\diff.module.css.mjs
		const css$3 = ".Y2KUmq_rows{font-family:var(--ds-font-family-code,monospace);padding:4px 0 8px;font-size:11px}.Y2KUmq_row{cursor:default;align-items:flex-start;gap:5px;padding:0 10px;line-height:18px;display:flex}.Y2KUmq_row[data-folded=true]{cursor:pointer}.Y2KUmq_lineNo{width:2.5em;color:var(--dsw-alias-label-tertiary);text-align:right;user-select:none;flex:none;font-size:10px}.Y2KUmq_sign{text-align:center;user-select:none;flex:none;width:1em;font-weight:700}.Y2KUmq_row[data-kind=del] .Y2KUmq_sign,.Y2KUmq_row[data-kind=del] .Y2KUmq_text{color:var(--dsw-alias-state-error-primary)}.Y2KUmq_row[data-kind=add] .Y2KUmq_sign,.Y2KUmq_row[data-kind=add] .Y2KUmq_text{color:var(--dsw-alias-state-success-primary)}.Y2KUmq_row[data-kind=mod] .Y2KUmq_sign,.Y2KUmq_row[data-kind=mod] .Y2KUmq_text{color:var(--dsw-alias-state-business-primary)}.Y2KUmq_row[data-kind=context] .Y2KUmq_sign,.Y2KUmq_row[data-kind=context] .Y2KUmq_text{color:var(--dsw-alias-label-secondary)}.Y2KUmq_row[data-kind=read] .Y2KUmq_text{color:var(--dsw-alias-label-primary)}.Y2KUmq_row[data-kind=del]{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent)}.Y2KUmq_row[data-kind=add]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 8%, transparent)}.Y2KUmq_row[data-kind=mod]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.Y2KUmq_row .Y2KUmq_text{white-space:pre-wrap;word-break:break-word;flex:1;min-width:0}.Y2KUmq_row[data-folded=true] .Y2KUmq_text{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.Y2KUmq_row[data-kind=meta] .Y2KUmq_metaText{color:var(--dsw-alias-label-tertiary);font-style:italic}.Y2KUmq_inlineChange{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 26%, transparent);border-radius:3px;padding:0 1px}.Y2KUmq_tokComment{color:var(--dsw-alias-label-tertiary);font-style:italic}.Y2KUmq_tokKeyword{color:color-mix(in oklab, var(--dsw-alias-state-business-primary) 55%, var(--dsw-alias-state-error-primary))}.Y2KUmq_tokString{color:color-mix(in oklab, var(--dsw-alias-state-success-primary) 45%, var(--dsw-alias-state-business-primary))}.Y2KUmq_tokType{color:color-mix(in oklab, var(--dsw-alias-brand-primary) 60%, var(--dsw-alias-state-success-primary))}.Y2KUmq_tokNumber{color:var(--dsw-alias-state-warn-primary)}.Y2KUmq_tokFunction{color:color-mix(in oklab, var(--dsw-alias-state-warn-primary) 55%, var(--dsw-alias-state-error-primary))}.Y2KUmq_tokMacro{color:color-mix(in oklab, var(--dsw-alias-state-error-primary) 45%, var(--dsw-alias-state-business-primary))}.Y2KUmq_foldRow{padding:0 10px}.Y2KUmq_foldRow[data-expandable=true]{cursor:pointer}.Y2KUmq_foldRow[data-expandable=true]:hover{background:var(--dsw-alias-interactive-bg-hover)}.Y2KUmq_foldRow[data-expanded=true]{cursor:default;padding:0}.Y2KUmq_foldRow[data-expanded=true] .Y2KUmq_foldMarker{display:none}.Y2KUmq_foldMarker{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:4px;align-items:center;gap:5px;margin:2px 0;padding:2px 7px;display:inline-flex}.Y2KUmq_foldRow[data-expandable=true] .Y2KUmq_foldMarker{color:var(--dsw-alias-label-secondary)}.Y2KUmq_foldRow[data-expandable=true] .Y2KUmq_foldMarker:before{content:\"›\";color:var(--dsw-alias-label-tertiary);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out)}.Y2KUmq_expand{border:1px solid var(--dsw-alias-border-l1);width:calc(100% - 20px);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;margin:4px 10px;padding:4px;font-size:11px;display:block}.Y2KUmq_expand:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Y2KUmq_files,.Y2KUmq_fileBlock{flex-direction:column;display:flex}.Y2KUmq_file{width:100%;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:6px 10px;font-size:11px;display:flex}.Y2KUmq_file:disabled{cursor:default}.Y2KUmq_file:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Y2KUmq_fileChevron{width:12px;color:var(--dsw-alias-label-tertiary);transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out);flex:none}.Y2KUmq_fileChevronExpanded{transform:rotate(90deg)}.Y2KUmq_filePath{font-family:var(--ds-font-family-code,monospace);color:var(--dsw-alias-label-primary);word-break:break-all;min-width:0}.Y2KUmq_fileOld{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code,monospace);flex:none;overflow:hidden}.Y2KUmq_fileTag{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:10px;line-height:16px}.Y2KUmq_fileStats{font-size:10px;font-family:var(--ds-font-family-code,monospace);flex:none;gap:5px;margin-left:auto;display:inline-flex}.Y2KUmq_statAdd{color:var(--dsw-alias-state-success-primary)}.Y2KUmq_statDel{color:var(--dsw-alias-state-error-primary)}.Y2KUmq_row:focus-visible,.Y2KUmq_foldRow:focus-visible,.Y2KUmq_file:focus-visible,.Y2KUmq_expand:focus-visible{outline:2px solid var(--dsw-alias-interactive-bg-hover-accent);outline-offset:-1px}@media (prefers-reduced-motion:reduce){.Y2KUmq_fileChevron{transition:none}}";
		...
		var diff_module_css_default = {
			"text": "Y2KUmq_text",
			"tokString": "Y2KUmq_tokString",
			"statDel": "Y2KUmq_statDel",
			"fileOld": "Y2KUmq_fileOld",
			"fileChevronExpanded": "Y2KUmq_fileChevronExpanded",
			"tokKeyword": "Y2KUmq_tokKeyword",
			"tokMacro": "Y2KUmq_tokMacro",
			"sign": "Y2KUmq_sign",
			"metaText": "Y2KUmq_metaText",
			"inlineChange": "Y2KUmq_inlineChange",
			"tokType": "Y2KUmq_tokType",
			"file": "Y2KUmq_file",
			"fileTag": "Y2KUmq_fileTag",
			"rows": "Y2KUmq_rows",
			"row": "Y2KUmq_row",
			"files": "Y2KUmq_files",
			"fileBlock": "Y2KUmq_fileBlock",
			"filePath": "Y2KUmq_filePath",
			"tokComment": "Y2KUmq_tokComment",
			"lineNo": "Y2KUmq_lineNo",
			"foldRow": "Y2KUmq_foldRow",
			"tokNumber": "Y2KUmq_tokNumber",
			"foldMarker": "Y2KUmq_foldMarker",
			"fileStats": "Y2KUmq_fileStats",
			"statAdd": "Y2KUmq_statAdd",
			"tokFunction": "Y2KUmq_tokFunction",
			"expand": "Y2KUmq_expand",
			"fileChevron": "Y2KUmq_fileChevron"
		};
		//#endregion
...
Mode: this is a continuable side conversation. Your answers stay in this side thread and are viewed in the side panel; they are never delivered into the parent session.`;
		...
		*/
		function deriveCatalogs(list) {
			const catalogs = {};
			const projections = list.projectionsBySession ?? {};
			for (const [parentSessionId, projection] of Object.entries(projections)) catalogs[parentSessionId] = {
				state: "ready",
				error: null,
		...
		*/
		function mapJobViewRows(rows) {
			const mapped = {};
			for (const [sessionId, jobs] of Object.entries(rows)) mapped[sessionId] = jobs.map(toSidebarJobView);
			return mapped;
		}
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\SubagentView.module.css.mjs
		const css$2 = ".ABdNlq_subagent{flex-direction:column;flex:1;min-height:0;display:flex}.ABdNlq_subagentHeader{flex:none;align-items:center;gap:8px;height:36px;padding:0 8px 0 12px;display:flex}.ABdNlq_subagentTitle{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.ABdNlq_subagentCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.ABdNlq_subagentRefresh{width:24px;height:24px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}.ABdNlq_subagentRefresh:hover{background:var(--dsw-alias-interactive-bg-hover)}.ABdNlq_subagentBody{flex:1;min-height:0;padding:2px 6px 8px;overflow-y:auto}.ABdNlq_subagentRow{box-sizing:border-box;width:100%;min-height:50px;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;display:flex;position:relative}.ABdNlq_subagentRow:hover,.ABdNlq_subagentRow:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.ABdNlq_subagentRowActive,.ABdNlq_subagentRowActive:hover,.ABdNlq_subagentRowActive:focus-visible{background:var(--dsw-alias-interactive-bg-active)}.ABdNlq_subagentRowDisabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.ABdNlq_subagentRowDisabled:hover{background:0 0}.ABdNlq_subagentRowLoading{cursor:default}.ABdNlq_subagentDot{margin-top:4px}.ABdNlq_subagentContent{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.ABdNlq_subagentLabel,.ABdNlq_subagentSecondary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.ABdNlq_subagentLabel{color:inherit;font-weight:400}.ABdNlq_subagentSecondary{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary)}.ABdNlq_subagentLive{min-width:0;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:4px;display:flex;overflow:hidden}.ABdNlq_subagentLiveTool{font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);flex:none}.ABdNlq_subagentLiveArgs{min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.ABdNlq_subagentLiveText{-webkit-line-clamp:2;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-secondary);-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.ABdNlq_subagentNode{min-width:0;position:relative}.ABdNlq_subagentChildren{margin-left:18px;padding-left:4px;position:relative}.ABdNlq_subagentChildren:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);height:26px;position:absolute;top:-26px;left:0}.ABdNlq_subagentChildren[aria-busy=true]:before{content:none}.ABdNlq_subagentChildren>.ABdNlq_subagentNode:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;top:0;bottom:0;left:-4px}.ABdNlq_subagentChildren>.ABdNlq_subagentNode:last-child:before{height:17px;bottom:auto}.ABdNlq_subagentChildren>.ABdNlq_subagentNode>.ABdNlq_subagentRow:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.ABdNlq_subagentEmpty{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;gap:2px;padding:16px;display:flex}.ABdNlq_subagentEmptyHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-dimmed)}.ABdNlq_subagentError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;display:flex}.ABdNlq_subagentErrorRetry{height:24px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxxs-strong-11);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;padding:0 8px;display:inline-flex}.ABdNlq_subagentErrorRetry:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.ABdNlq_jobs{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:8px}.ABdNlq_jobsHeader{align-items:center;gap:8px;height:26px;padding:0 2px;display:flex}.ABdNlq_jobsTitle{min-width:0;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.ABdNlq_jobsCount{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.ABdNlq_jobsList{flex-direction:column;gap:2px;margin:0;padding:0;list-style:none;display:flex}.ABdNlq_jobsRow{border-radius:8px;align-items:center;gap:4px;display:flex}.ABdNlq_jobsRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.ABdNlq_jobsRowSettled{opacity:.8}.ABdNlq_jobsRowSelected,.ABdNlq_jobsRowSelected:hover{background:var(--dsw-alias-interactive-bg-active)}.ABdNlq_jobsRowMain{min-width:0;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;outline:none;flex:1;align-items:flex-start;gap:8px;padding:6px 8px 6px 11px;display:flex}.ABdNlq_jobsRowMain:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.ABdNlq_jobsDot{margin-top:5px}.ABdNlq_jobsContent{flex-direction:column;gap:1px;min-width:0;display:flex}.ABdNlq_jobsLabelLine{align-items:center;gap:6px;min-width:0;display:flex}.ABdNlq_jobsKind{text-overflow:ellipsis;white-space:nowrap;border:1px solid var(--dsw-alias-border-l2);max-width:90px;font:var(--dsw-font-xxxs-strong-11);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;padding:0 5px;line-height:14px;overflow:hidden}.ABdNlq_jobsLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.ABdNlq_jobsSecondary{text-overflow:ellipsis;white-space:nowrap;font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);overflow:hidden}.ABdNlq_jobsKill{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;margin-right:4px;display:inline-flex}.ABdNlq_jobsKill:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);color:var(--dsw-alias-state-error-primary)}.ABdNlq_jobsKillArmed,.ABdNlq_jobsKillArmed:hover{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);width:auto;height:20px;color:var(--dsw-alias-state-error-primary);font:var(--dsw-font-xxxs-strong-11);white-space:nowrap;padding:0 8px}.ABdNlq_jobsKill:disabled{opacity:.5;cursor:default}.ABdNlq_jobsKillError{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-state-error-primary);flex:none;margin-right:4px}.ABdNlq_jobsPane{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;margin-top:4px;position:sticky;bottom:0;overflow:hidden;box-shadow:0 -6px 12px -8px #00000059}.ABdNlq_jobsPaneHeader{border-bottom:1px solid var(--dsw-alias-border-l1);align-items:center;gap:6px;height:28px;padding:0 4px 0 10px;display:flex}.ABdNlq_jobsPaneDot{flex:none}.ABdNlq_jobsPaneLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);line-height:var(--dsw-font-xxxs-11-line-height);color:var(--dsw-alias-label-primary);flex:1;overflow:hidden}.ABdNlq_jobsPaneStatus{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);flex:none}.ABdNlq_jobsPaneClose{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;flex:none;justify-content:center;align-items:center;display:inline-flex}.ABdNlq_jobsPaneClose:hover{background:var(--dsw-alias-interactive-bg-hover)}.ABdNlq_jobsPanePre{max-height:200px;font-family:var(--ds-font-family-code);font-size:var(--dsw-font-xxxs-11-font-size);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;margin:0;padding:6px 10px;line-height:1.5;overflow:auto}.ABdNlq_jobsPaneHint{font:var(--dsw-font-xxxs-11);color:var(--dsw-alias-label-tertiary);padding:8px 10px}.ABdNlq_jobsPaneError{color:var(--dsw-alias-state-error-primary)}";
		...
		var SubagentView_module_css_default = {
			"jobsContent": "ABdNlq_jobsContent",
			"jobsKillArmed": "ABdNlq_jobsKillArmed",
			"jobsPaneStatus": "ABdNlq_jobsPaneStatus",
			"subagentLabel": "ABdNlq_subagentLabel",
			"subagentRowLoading": "ABdNlq_subagentRowLoading",
			"subagentSecondary": "ABdNlq_subagentSecondary",
			"subagentRefresh": "ABdNlq_subagentRefresh",
			"subagentError": "ABdNlq_subagentError",
			"subagentTitle": "ABdNlq_subagentTitle",
			"subagentErrorRetry": "ABdNlq_subagentErrorRetry",
			"jobsTitle": "ABdNlq_jobsTitle",
			"jobsList": "ABdNlq_jobsList",
			"subagentNode": "ABdNlq_subagentNode",
			"jobsRow": "ABdNlq_jobsRow",
			"jobsKillError": "ABdNlq_jobsKillError",
			"jobsPane": "ABdNlq_jobsPane",
			"jobsPaneHint": "ABdNlq_jobsPaneHint",
			"jobsPaneError": "ABdNlq_jobsPaneError",
			"subagentBody": "ABdNlq_subagentBody",
			"subagentLiveArgs": "ABdNlq_subagentLiveArgs",
			"jobsRowSettled": "ABdNlq_jobsRowSettled",
			"jobsCount": "ABdNlq_jobsCount",
			"subagent": "ABdNlq_subagent",
			"subagentCount": "ABdNlq_subagentCount",
			"subagentHeader": "ABdNlq_subagentHeader",
			"subagentRowDisabled": "ABdNlq_subagentRowDisabled",
			"jobsDot": "ABdNlq_jobsDot",
			"jobsLabel": "ABdNlq_jobsLabel",
			"jobsHeader": "ABdNlq_jobsHeader",
			"subagentDot": "ABdNlq_subagentDot",
			"jobsRowSelected": "ABdNlq_jobsRowSelected",
			"subagentLiveTool": "ABdNlq_subagentLiveTool",
			"jobsKill": "ABdNlq_jobsKill",
			"jobsPaneDot": "ABdNlq_jobsPaneDot",
			"subagentChildren": "ABdNlq_subagentChildren",
			"jobsKind": "ABdNlq_jobsKind",
			"subagentLive": "ABdNlq_subagentLive",
			"subagentRowActive": "ABdNlq_subagentRowActive",
			"subagentEmpty": "ABdNlq_subagentEmpty",
			"subagentRow": "ABdNlq_subagentRow",
			"jobsSecondary": "ABdNlq_jobsSecondary",
			"jobsLabelLine": "ABdNlq_jobsLabelLine",
			"jobsRowMain": "ABdNlq_jobsRowMain",
			"subagentContent": "ABdNlq_subagentContent",
			"jobsPaneLabel": "ABdNlq_jobsPaneLabel",
			"jobs": "ABdNlq_jobs",
			"jobsPaneClose": "ABdNlq_jobsPaneClose",
			"subagentLiveText": "ABdNlq_subagentLiveText",
			"subagentEmptyHint": "ABdNlq_subagentEmptyHint",
			"jobsPaneHeader": "ABdNlq_jobsPaneHeader",
			"jobsPanePre": "ABdNlq_jobsPanePre"
		};
		//#endregion
		...
		*/
		...
		const EMPTY_JOBS_SNAPSHOT = { rows: {} };
		...
		*/
		function JobsSection(props) {
			...
			const rows = (0, react.useMemo)(() => orderJobs(collectTreeJobs(byId, jobRows, rootId)), [
				byId,
				jobRows,
				rootId
			]);
		...
		*/
		function SubagentView(props) {
			...
			const catalogs = (0, react.useMemo)(() => deriveCatalogs(list), [list]);
			const jobsService = ctx.get("jobs");
			const jobsSnapshot = (0, react.useSyncExternalStore)((0, react.useMemo)(() => (callback) => jobsService?.state.subscribe(callback) ?? (() => {}), [jobsService]), (0, react.useCallback)(() => jobsService?.state.getSnapshot() ?? EMPTY_JOBS_SNAPSHOT, [jobsService]));
			const jobRows = (0, react.useMemo)(() => jobsService === void 0 ? list.jobsBySession : mapJobViewRows(jobsSnapshot.rows), [
				jobsService,
				jobsSnapshot,
				list.jobsBySession
			]);
			...
			(0, react.useEffect)(() => {
				if (!active || jobsService === void 0) return;
			...
			const ensureLoaded = (0, react.useCallback)((parentSessionId) => {
		...
		*  is exactly the changed tail. */
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\SideChatView.module.css.mjs
		const css$1 = "._026D6W_sidechat{flex-direction:column;flex:1;min-height:0;display:flex}._026D6W_sidechatDetailHeader{border-bottom:1px solid var(--dsw-alias-hairline);flex:none;align-items:center;gap:4px;min-height:36px;padding:4px 8px 4px 12px;display:flex}._026D6W_sidechatHeaderDot{flex:none}._026D6W_sidechatHeaderSpacer{flex:1;min-width:0}._026D6W_sidechatAgentBadge{border:1px solid var(--dsw-alias-hairline);max-width:55%;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;border-radius:999px;flex:none;padding:1px 8px;overflow:hidden}._026D6W_sidechatIconBtn{width:26px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .1s ease-out,color .1s ease-out;display:inline-flex}._026D6W_sidechatIconBtn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._026D6W_sidechatIconBtn:disabled{opacity:.4;cursor:default}._026D6W_sidechatHero{min-height:0;color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:8px;padding:24px 20px;animation:.2s ease-out _026D6W_sidechatFadeIn;display:flex}._026D6W_sidechatHeroTitle{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);font-weight:500}._026D6W_sidechatHeroDesc{max-width:300px;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);line-height:1.6}._026D6W_sidechatPrimaryBtn{background:var(--dsw-alias-button-info-fill,var(--dsw-alias-accent));color:var(--dsw-alias-button-info-label,var(--dsw-alias-accent-ink,#fff));font:var(--dsw-font-s-13);cursor:pointer;border:none;border-radius:999px;flex:none;margin-top:4px;padding:6px 14px;transition:opacity .1s ease-out}._026D6W_sidechatPrimaryBtn:hover:not(:disabled){opacity:.88}._026D6W_sidechatPrimaryBtn:disabled{opacity:.4;cursor:default}._026D6W_sidechatHint{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);flex:none;padding:4px 12px}._026D6W_sidechatError{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-danger);flex:none;padding:4px 12px}._026D6W_sidechatScroll{flex-direction:column;flex:1;gap:10px;min-height:0;padding:10px 12px;display:flex;overflow-y:auto}._026D6W_sidechatScroll>*{animation:.18s ease-out _026D6W_sidechatRowIn}._026D6W_sidechatUser{background:var(--dsw-specific-bubble,var(--dsw-alias-bg-base));max-width:88%;font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;border-radius:18px;align-self:flex-end;padding:8px 14px}._026D6W_sidechatAssistant{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;align-self:stretch}._026D6W_sidechatRow{align-self:stretch}._026D6W_sidechatRowLine{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;padding:1px 0;display:flex}._026D6W_sidechatRowSummary{cursor:pointer;user-select:none;list-style:none}._026D6W_sidechatRowSummary::-webkit-details-marker{display:none}._026D6W_sidechatRowSummary:hover{color:var(--dsw-alias-label-secondary)}._026D6W_sidechatRowStatic{cursor:default}._026D6W_sidechatRowChevron{flex:none;align-items:center;transition:transform .1s ease-out;display:inline-flex}._026D6W_sidechatRow[open] ._026D6W_sidechatRowChevron{transform:rotate(90deg)}._026D6W_sidechatRowIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}._026D6W_sidechatRowLabel{text-overflow:ellipsis;white-space:nowrap;max-width:60%;color:var(--dsw-alias-label-secondary);flex:none;overflow:hidden}._026D6W_sidechatRowMono{font-family:var(--dsw-font-mono)}._026D6W_sidechatRowMeta{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-family:var(--dsw-font-mono);color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}._026D6W_sidechatRowFailed ._026D6W_sidechatRowLabel,._026D6W_sidechatRowFailed ._026D6W_sidechatRowMeta{color:var(--dsw-alias-danger)}._026D6W_sidechatRowBody{border-left:1px solid var(--dsw-alias-hairline);margin:2px 0 4px 7px;padding:2px 0 2px 10px}._026D6W_sidechatRowProse{font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;max-height:240px;overflow-y:auto}._026D6W_sidechatRowCode{font:var(--dsw-font-xxs-12);font-family:var(--dsw-font-mono);color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;max-height:220px;margin:0;padding:4px 0;overflow-y:auto}._026D6W_sidechatRowCode+._026D6W_sidechatRowCode{border-top:1px solid var(--dsw-alias-hairline)}._026D6W_sidechatRowBody>*{margin-top:2px}._026D6W_sidechatTurnSummary{max-width:88%;font:var(--dsw-font-xxs-12);font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-tertiary);user-select:none;align-self:flex-end;padding:0 2px}._026D6W_sidechatShimmerText{background-image:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-primary) 50%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-size:200% 100%;-webkit-background-clip:text;background-clip:text;animation:2.6s linear infinite _026D6W_sidechatSweep}._026D6W_sidechatStatus{flex:none;align-items:center;gap:8px;padding:2px 14px 6px;animation:.16s ease-out _026D6W_sidechatFadeIn;display:flex}._026D6W_sidechatStatusText{font:var(--dsw-font-xxs-12);background-image:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-primary) 50%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-size:200% 100%;-webkit-background-clip:text;background-clip:text;animation:2.6s linear infinite _026D6W_sidechatSweep}._026D6W_sidechatComposer{border:1px solid var(--dsw-alias-border-l2-darkmode-thin,var(--dsw-alias-hairline));background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));box-shadow:var(--dsw-shadow-lv2,none);border-radius:16px;flex-direction:column;flex:none;gap:4px;margin:0 8px 8px;padding:8px 8px 6px 14px;display:flex}._026D6W_sidechatComposerInput{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);resize:none;background:0 0;border:none;outline:none;max-height:132px;padding:2px 0;line-height:22px}._026D6W_sidechatComposerInput::placeholder{color:var(--dsw-alias-label-tertiary)}._026D6W_sidechatComposerBar{flex:none;align-items:center;gap:8px;min-height:28px;display:flex}._026D6W_sidechatComposerMeta{min-width:0;font:var(--dsw-font-xxs-12);color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}._026D6W_sidechatSendBtn{background:var(--dsw-alias-button-info-fill,var(--dsw-alias-accent));width:28px;height:28px;color:var(--dsw-alias-button-info-label,var(--dsw-alias-accent-ink,#fff));cursor:pointer;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;transition:opacity .1s ease-out;animation:.12s ease-out _026D6W_sidechatBtnIn;display:inline-flex}._026D6W_sidechatSendBtn:hover:not(:disabled){opacity:.88}._026D6W_sidechatSendBtn:disabled{opacity:.35;cursor:default}@keyframes _026D6W_sidechatRowIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}@keyframes _026D6W_sidechatFadeIn{0%{opacity:0}to{opacity:1}}@keyframes _026D6W_sidechatBtnIn{0%{opacity:0;transform:scale(.85)}to{opacity:1;transform:scale(1)}}@keyframes _026D6W_sidechatSweep{0%{background-position:200% 0}to{background-position:-200% 0}}@media (prefers-reduced-motion:reduce){._026D6W_sidechatScroll>*,._026D6W_sidechatHero,._026D6W_sidechatStatus,._026D6W_sidechatSendBtn{animation:none}._026D6W_sidechatStatusText,._026D6W_sidechatShimmerText{color:var(--dsw-alias-label-tertiary);background-image:none;animation:none}._026D6W_sidechatRowChevron{transition:none}}";
		...
		var SideChatView_module_css_default = {
			"sidechatRowCode": "_026D6W_sidechatRowCode",
			"sidechatAssistant": "_026D6W_sidechatAssistant",
			"sidechatRowMono": "_026D6W_sidechatRowMono",
			"sidechatHeaderSpacer": "_026D6W_sidechatHeaderSpacer",
			"sidechatHeroDesc": "_026D6W_sidechatHeroDesc",
			"sidechatRowLabel": "_026D6W_sidechatRowLabel",
			"sidechatRowLine": "_026D6W_sidechatRowLine",
			"sidechatRowIn": "_026D6W_sidechatRowIn",
			"sidechatError": "_026D6W_sidechatError",
			"sidechatIconBtn": "_026D6W_sidechatIconBtn",
			"sidechatHeroTitle": "_026D6W_sidechatHeroTitle",
			"sidechatDetailHeader": "_026D6W_sidechatDetailHeader",
			"sidechatTurnSummary": "_026D6W_sidechatTurnSummary",
			"sidechatHero": "_026D6W_sidechatHero",
			"sidechatSendBtn": "_026D6W_sidechatSendBtn",
			"sidechatRowIcon": "_026D6W_sidechatRowIcon",
			"sidechatStatusText": "_026D6W_sidechatStatusText",
			"sidechatSweep": "_026D6W_sidechatSweep",
			"sidechatComposerInput": "_026D6W_sidechatComposerInput",
			"sidechatRowFailed": "_026D6W_sidechatRowFailed",
			"sidechatRowMeta": "_026D6W_sidechatRowMeta",
			"sidechatComposerMeta": "_026D6W_sidechatComposerMeta",
			"sidechatPrimaryBtn": "_026D6W_sidechatPrimaryBtn",
			"sidechatRowSummary": "_026D6W_sidechatRowSummary",
			"sidechatHeaderDot": "_026D6W_sidechatHeaderDot",
			"sidechatHint": "_026D6W_sidechatHint",
			"sidechatComposer": "_026D6W_sidechatComposer",
			"sidechatRowBody": "_026D6W_sidechatRowBody",
			"sidechatBtnIn": "_026D6W_sidechatBtnIn",
			"sidechatRow": "_026D6W_sidechatRow",
			"sidechatRowChevron": "_026D6W_sidechatRowChevron",
			"sidechatAgentBadge": "_026D6W_sidechatAgentBadge",
			"sidechatScroll": "_026D6W_sidechatScroll",
			"sidechatUser": "_026D6W_sidechatUser",
			"sidechatFadeIn": "_026D6W_sidechatFadeIn",
			"sidechatRowStatic": "_026D6W_sidechatRowStatic",
			"sidechatRowProse": "_026D6W_sidechatRowProse",
			"sidechatShimmerText": "_026D6W_sidechatShimmerText",
			"sidechatStatus": "_026D6W_sidechatStatus",
			"sidechatComposerBar": "_026D6W_sidechatComposerBar",
			"sidechat": "_026D6W_sidechat"
		};
		//#endregion
			...
			*  already-open tab when there is one. */
			...
			if (threadId === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconNewChatOutlineRegular, { size: 16 }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconStopFillRegular, { size: 16 })
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLinkOutlineRegular, { size: 14 })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: sidebar_module_css_default.iconButton,
		...
		*  sidebar/bottom-toggle.tsx — registered into DSH's session header). */
		...
		//#endregion
		//#region src/client/native/tab-state.ts
		/** localStorage namespace of the native-tab memory. */
		const NATIVE_TAB_STATE_KEY = "dsh-better-sidebar.native-tabs.v1";
		/** One entry larger than this is not remembered (a huge diff stays transient). */
		const MAX_ENTRY_BYTES = 65536;
		...
		function compact(memory) {
			return {
				...memory.path === void 0 ? {} : { path: memory.path },
				...memory.title === void 0 ? {} : { title: memory.title },
				...memory.meta === void 0 ? {} : { meta: memory.meta },
				...memory.diff === void 0 ? {} : { diff: memory.diff }
			};
		}
		/**
		...
		*/
		function createNativeTabStateStore() {
			let document;
			const read = () => {
				...
				try {
					...
					if (parsed !== null && typeof parsed === "object" && !Array.isArray(parsed)) for (const [sessionId, entries] of Object.entries(parsed)) {
			...
			return {
				...
				remember(sessionId, tabId, memory) {
					...
					if (JSON.stringify(kept).length > MAX_ENTRY_BYTES) {
				...
				forget(sessionId, tabId) {
					...
					if (session === void 0 || session[tabId] === void 0) return;
		...
		*/
		function createNativeTabRecords(memory = createNativeTabStateStore()) {
			...
			const remember = (view) => {
				memory.remember(view.scope.sessionId, view.tab.id, {
					...view.tab.path === void 0 ? {} : { path: view.tab.path },
					...view.tab.title === void 0 ? {} : { title: view.tab.title },
					...view.tab.meta === void 0 ? {} : { meta: view.tab.meta },
					...view.tab.diff === void 0 ? {} : { diff: view.tab.diff }
				});
			};
			return {
					...
					if (existing === void 0) {
						...
						const seeded = params?.title === void 0 && params?.meta === void 0 && recalled?.meta === void 0 ? mint?.() : void 0;
						...
						const minted = {
							tab: {
								...
								...nextDiff === void 0 ? {} : { diff: nextDiff },
								...nextMeta === void 0 ? {} : { meta: nextMeta }
							},
							scope,
							address: address ?? "",
							expanded: [],
				...
				has: (id) => views.has(id),
				openTabs() {
					return [...views].map(([id, view]) => ({
						id,
						sessionId: view.scope.sessionId,
						tab: view.tab
					}));
				},
				...
				drop(id) {
					const entry = views.get(id);
					if (entry !== void 0) memory.forget(entry.scope.sessionId, id);
			...
			const seat = ctx.inject(["sidebarRightTabs"], (injected) => {
				...
				const registerDescriptor = (descriptor) => {
					...
					const disposeType = tabs.register({
						...
						priority: "extension",
						...descriptor.single !== true && (descriptor.createTab !== void 0 || descriptor.dedupeKey !== void 0) ? { multiple: true } : {},
		...
		*/
		function createNativeSurface(ctx, records) {
			...
			const place = (entry) => {
				...
				const options = {
					...entry.line === void 0 && entry.params === void 0 ? {} : { params: {
						...entry.line === void 0 ? {} : { line: entry.line },
						...entry.params
					} },
					revealIfOpened: entry.revealIfOpened,
					...entry.preferNewPane ? { preferNewPane: true } : {},
					...entry.replaceTab === void 0 ? {} : { replaceTab: entry.replaceTab }
				};
				if (onScreen) {
			...
			const openTab = ({ sessionId, kind, params, revealIfOpened, preferNewPane = false }) => {
				enqueue({
					kind: "tab",
					sessionId,
					tabKind: kind,
			...
			const openResource = ({ sessionId, address, line, params, revealIfOpened, preferNewPane = false, replaceTab }) => {
				enqueue({
					kind: "resource",
					sessionId,
					address,
			...
			return {
				...
				update(tabId, patch) {
					...
					if (patch.path !== void 0 && records.get(tabId)?.tab.path !== patch.path) {
						const address = records.addressOf(tabId);
						const scope = records.scopeOf(tabId);
						if (address !== void 0 && scope !== void 0 && parseFileAddress(address) !== void 0) {
							...
							if (next !== address) {
								...
								openResource({
									...
									replaceTab: tabId,
									...patch.title === void 0 && meta === void 0 ? {} : { params: {
										...patch.title === void 0 ? {} : { title: patch.title },
										...meta === void 0 ? {} : { meta }
									} }
								});
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-plugins\better-sidebar\src\client\layout.css.mjs
